/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 693c3d3c49552a5cb57b58817ba74b35)
...
declare namespace Cloudflare {
	interface Env {
		...
		ADMIN_PASS: string;
		FORM_SESSION: DurableObjectNamespace<import("./dist/_worker.js/index").FormSessionDO>;
		DB: D1Database;
		AI: Ai;
		VECTORIZE: VectorizeIndex;
		AIGate: DurableObjectNamespace<import("./src/lib/ai/aiGate").AIGate>;
		ASSETS: Fetcher;
