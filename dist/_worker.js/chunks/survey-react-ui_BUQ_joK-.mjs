...
import { createPopupViewModel, settings, createPopupModalViewModel, PopupSurveyModel, ScrollViewModel, Model as SurveyModel, Helpers, SurveyProgressModel, ProgressButtonsResponsivityManager, SvgRegistry, createSvg, doKey2ClickBlur, doKey2ClickDown, doKey2ClickUp, CssClassBuilder, Question, ButtonGroupItemModel, RendererFactory, addIconsToThemeSet, LocalizableString, checkLibraryVersion, ActionDropdownViewModel } from './survey-core_BiQ_gE3i.mjs';
export { SurveyWindowModel, surveyLocalization, surveyStrings } from './survey-core_BiQ_gE3i.mjs';
import { a as reactExports } from './_@astro-renderers_DXs7ZzLR.mjs';
import { r as reactDomExports } from './index_Dm3YC4lW.mjs';
...
class SurveyElementBase extends reactExports.Component {
    ...
    static renderQuestionDescription(question) {
        ...
        return reactExports.createElement("div", { style: question.hasDescription ? undefined : { display: "none" }, id: question.ariaDescriptionId, className: question.cssDescription }, descriptionText);
    }
    constructor(props) {
        super(props);
...
class SurveyRowElement extends SurveyElementBase {
    constructor(props) {
        ...
        this.rootRef = reactExports.createRef();
    }
    getStateElement() {
        return this.element;
    }
    ...
    renderElement() {
        ...
        return (reactExports.createElement("div", { className: css.questionWrapper, style: element.rootStyle, "data-key": element.name + this.index, onFocus: focusIn, ref: this.rootRef }, innerElement));
    }
...
class SurveyRow extends SurveyElementBase {
    ...
    renderElementContent() {
        const elements = this.row.visibleElements.map((element, elementIndex) => {
            return (reactExports.createElement(SurveyRowElement, { element: element, index: elementIndex, row: this.row, survey: this.survey, creator: this.creator, css: this.css, key: element.id }));
        });
        return (reactExports.createElement("div", { ref: this.rootRef, className: this.row.getRowCss() }, elements));
    }
    renderElement() {
...
class SurveyPanelBase extends SurveyElementBase {
    ...
    createRow(row, css) {
        return (reactExports.createElement(SurveyRow, { key: row.id, row: row, survey: this.survey, creator: this.creator, css: css }));
    }
}

class SvgIcon extends reactExports.Component {
    constructor(props) {
        super(props);
        this.svgIconRef = reactExports.createRef();
    }
    updateSvg() {
    ...
    render() {
        ...
        return (this.props.iconName ?
            reactExports.createElement("svg", { className: className, style: this.props.style, onClick: this.props.onClick, ref: this.svgIconRef, role: "presentation" },
                reactExports.createElement("use", null))
            : null);
    }
    componentDidMount() {
        this.updateSvg();
...
ReactElementFactory.Instance.registerElement("sv-svg-icon", (props) => {
    return reactExports.createElement(SvgIcon, props);
});

class SurveyActionBarSeparator extends reactExports.Component {
    constructor(props) {
        super(props);
    }
    render() {
        var className = `sv-action-bar-separator ${this.props.cssClasses}`;
        return reactExports.createElement("div", { className: className });
    }
}
ReactElementFactory.Instance.registerElement("sv-action-bar-separator", (props) => {
    return reactExports.createElement(SurveyActionBarSeparator, props);
});
...
class SurveyAction extends SurveyElementBase {
    ...
    renderElement() {
        ...
        const separator = this.item.needSeparator ? (reactExports.createElement(SurveyActionBarSeparator, null)) : null;
        const itemComponent = ReactElementFactory.Instance.createElement(this.item.component || "sv-action-bar-item", {
            item: this.item,
        });
        return (reactExports.createElement("div", { className: itemClass, id: this.item.id, ref: this.ref },
            reactExports.createElement("div", { className: "sv-action__content" },
                separator,
                itemComponent)));
    }
    componentWillUnmount() {
...
class SurveyActionBarItem extends SurveyElementBase {
    ...
    renderElement() {
        return reactExports.createElement(reactExports.Fragment, null, this.renderInnerButton());
    }
    renderText() {
        if (!this.item.hasTitle)
            return null;
        const titleClass = this.item.getActionBarItemTitleCss();
        return reactExports.createElement("span", { className: titleClass }, this.item.title);
    }
    renderButtonContent() {
        const text = this.renderText();
        const svgIcon = !!this.item.iconName ? (reactExports.createElement(SvgIcon, { className: this.item.cssClasses.itemIcon, size: this.item.iconSize, iconName: this.item.iconName, title: this.item.tooltip || this.item.title })) : null;
    ...
    renderInnerButton() {
        ...
        const button = attachKey2click(reactExports.createElement("button", { className: className, type: "button", disabled: this.item.disabled, onMouseDown: (args) => this.item.doMouseDown(args), onFocus: (args) => this.item.doFocus(args), onClick: (args) => this.item.doAction(args), title: title, tabIndex: tabIndex, "aria-checked": this.item.ariaChecked, "aria-expanded": this.item.ariaExpanded, role: this.item.ariaRole }, buttonContent), this.item, { processEsc: false });
        return button;
    }
}
ReactElementFactory.Instance.registerElement("sv-action-bar-item", (props) => {
    return reactExports.createElement(SurveyActionBarItem, props);
});
...
class Popup extends SurveyElementBase {
    ...
    render() {
        ...
        if (this.model.isModal) {
            popupContainer = reactExports.createElement(PopupContainer, { model: this.popup });
        }
        else {
            popupContainer = reactExports.createElement(PopupDropdownContainer, { model: this.popup });
        }
        return reactExports.createElement("div", { ref: this.containerRef }, popupContainer);
    }
}
ReactElementFactory.Instance.registerElement("sv-popup", (props) => {
    return reactExports.createElement(Popup, props);
});
class PopupContainer extends SurveyElementBase {
    ...
    renderContainer(popupBaseViewModel) {
        ...
        return (reactExports.createElement("div", { className: "sv-popup__container", style: {
            ...
            headerPopup,
            reactExports.createElement("div", { className: "sv-popup__body-content" },
                headerContent,
                reactExports.createElement("div", { className: "sv-popup__scrolling-content" }, content),
                footerContent)));
    }
    renderHeaderContent() {
        return reactExports.createElement("div", { className: "sv-popup__body-header" }, this.model.title);
    }
    renderContent() {
        ...
        return reactExports.createElement("div", { className: "sv-popup__content" }, contentComponent);
    }
    renderHeaderPopup(popupModel) {
        return null;
    }
    renderFooter(popuModel) {
        return (reactExports.createElement("div", { className: "sv-popup__body-footer" },
            reactExports.createElement(SurveyActionBar, { model: popuModel.footerToolbar })));
    }
    render() {
        ...
        return (reactExports.createElement("div", { tabIndex: -1, className: className, style: style, onClick: (e) => {
...
class PopupDropdownContainer extends PopupContainer {
    renderHeaderPopup(popupModel) {
        ...
        if (!popupDropdownModel)
            return null;
        return (reactExports.createElement("span", { style: {
...
class SurveyActionBarItemDropdown extends SurveyActionBarItem {
    ...
    renderInnerButton() {
        ...
        return (reactExports.createElement(reactExports.Fragment, null,
            button,
            reactExports.createElement(Popup, { model: this.item.popupModel })));
    }
    componentDidMount() {
...
ReactElementFactory.Instance.registerElement("sv-action-bar-item-dropdown", (props) => {
    return reactExports.createElement(SurveyActionBarItemDropdown, props);
});
...
class SurveyActionBar extends SurveyElementBase {
    ...
    renderElement() {
        ...
        return (reactExports.createElement("div", { ref: this.rootRef, style: this.model.getRootStyle(), className: this.model.getRootCss(), onClick: this.handleClick ? function (event) {
                event.stopPropagation();
            } : undefined }, items));
    }
    renderItems() {
        return this.model.renderedActions.concat([]).map((item, itemIndex) => {
            return (reactExports.createElement(SurveyAction, { item: item, key: item.renderedId }));
        });
    }
}
ReactElementFactory.Instance.registerElement("sv-action-bar", (props) => {
    return reactExports.createElement(SurveyActionBar, props);
});

class TitleContent extends reactExports.Component {
    constructor(props) {
        super(props);
    }
    get cssClasses() {
    ...
    render() {
        ...
        return reactExports.createElement(reactExports.Fragment, null, spans);
    }
    renderTitleSpans(element, cssClasses) {
        var getSpaceSpan = (key) => {
            return (reactExports.createElement("span", { "data-key": key, key: key }, "\u00A0"));
        };
        var spans = [];
        ...
        if (questionNumber) {
            spans.push(reactExports.createElement("span", { "data-key": "q_num", key: "q_num", className: element.cssTitleNumber, style: { position: "static" }, "aria-hidden": true }, questionNumber));
    ...
    renderRequireText(element) {
        return (reactExports.createElement("span", { "data-key": "req-text", key: "req-text", className: element.cssRequiredMark, "aria-hidden": true }, element.requiredMark));
    }
}

class TitleActions extends reactExports.Component {
    get cssClasses() {
        return this.props.cssClasses;
    }
    get element() {
    ...
    render() {
        const titleContent = reactExports.createElement(TitleContent, { element: this.element, cssClasses: this.cssClasses });
        if (!this.element.hasTitleActions)
            return titleContent;
        return (reactExports.createElement("div", { className: "sv-title-actions" },
            reactExports.createElement("span", { className: "sv-title-actions__title" }, titleContent),
            reactExports.createElement(SurveyActionBar, { model: this.element.getTitleToolbar() })));
    }
}
...
ReactElementFactory.Instance.registerElement("sv-title-actions", (props) => {
    return reactExports.createElement(TitleActions, props);
});

class TitleElement extends reactExports.Component {
    constructor(props) {
        super(props);
    }
    get element() {
    ...
    renderTitleExpandableSvg() {
        ...
        return reactExports.createElement(SvgIcon, { className: this.element.getCssTitleExpandableSvg(), iconName: iconName, size: "auto" });
    }
    render() {
        const element = this.element;
        ...
        const titleContent = (reactExports.createElement(TitleActions, { element: element, cssClasses: element.cssClasses }));
        ...
        return (reactExports.createElement(CustomTag, { className: element.cssTitle, id: element.ariaTitleId, "aria-label": ariaLabel, tabIndex: element.titleTabIndex, "aria-expanded": element.titleAriaExpanded, role: element.titleAriaRole, onClick: onClick, onKeyUp: onKeyUp },
            titleExpandableSvg,
            titleContent));
    }
}
...
class CharacterCounterComponent extends SurveyElementBase {
    ...
    renderElement() {
        return (reactExports.createElement("div", { className: this.props.remainingCharacterCounter }, this.props.counter.remainingCharacterCounter));
    }
}
ReactElementFactory.Instance.registerElement("sv-character-counter", (props) => {
    return reactExports.createElement(CharacterCounterComponent, props);
});
...
class TextAreaComponent extends SurveyElementBase {
    constructor(props) {
        ...
        this.textareaRef = reactExports.createRef();
    }
    get viewModel() {
...
class SurveyQuestionComment extends SurveyQuestionUncontrolledElement {
    renderCharacterCounter() {
        ...
        if (!!this.question.getMaxLength()) {
            counter = reactExports.createElement(CharacterCounterComponent, { counter: this.question.characterCounter, remainingCharacterCounter: this.question.cssClasses.remainingCharacterCounter });
        }
        return counter;
    }
    constructor(props) {
    ...
    renderElement() {
        if (this.question.isReadOnlyRenderDiv()) {
            return reactExports.createElement("div", null, this.question.value);
        }
        const counter = this.renderCharacterCounter();
        const textAreaModel = this.props.question.textAreaModel;
        return (reactExports.createElement(reactExports.Fragment, null,
            reactExports.createElement(TextAreaComponent, { viewModel: textAreaModel }),
            counter));
    }
}
class SurveyQuestionCommentItem extends ReactSurveyElement {
    ...
    renderElement() {
        ...
        if (question.isReadOnlyRenderDiv()) {
            ...
            return reactExports.createElement("div", null, comment);
        }
        return (reactExports.createElement(TextAreaComponent, { key: this.getKey(), viewModel: this.textAreaModel }));
    }
...
ReactQuestionFactory.Instance.registerQuestion("comment", (props) => {
    return reactExports.createElement(SurveyQuestionComment, props);
});

class SurveyCustomWidget extends SurveyQuestionElementBase {
    constructor(props) {
        super(props);
        this.widgetRef = reactExports.createRef();
    }
    _afterRender() {
    ...
    renderElement() {
        ...
        if (customWidget.isDefaultRender) {
            return (reactExports.createElement("div", { ref: this.widgetRef }, this.creator.createQuestionElement(this.questionBase)));
        }
        let widget = null;
        if (customWidget.widgetJson.render) {
            ...
            if (customWidget.htmlTemplate) {
                ...
                return reactExports.createElement("div", { ref: this.widgetRef, dangerouslySetInnerHTML: htmlValue });
            }
        }
        return reactExports.createElement("div", { ref: this.widgetRef }, widget);
    }
}
...
class SurveyElementHeader extends SurveyElementBase {
    ...
    renderElement() {
        const element = this.element;
        const title = element.hasTitle ? (reactExports.createElement(TitleElement, { element: element })) : null;
        const description = element.hasDescriptionUnderTitle
            ? SurveyElementBase.renderQuestionDescription(this.element)
            : null;
        const additionalTitleToolbarElement = element.hasAdditionalTitleToolbar ? reactExports.createElement(SurveyActionBar, { model: element.additionalTitleToolbar }) : null;
        const headerStyle = { width: undefined };
        if (element instanceof Question) {
            headerStyle.width = element.titleWidth;
        }
        return (reactExports.createElement("div", { className: element.cssHeader, onClick: (e) => element.clickTitleFunction && element.clickTitleFunction(e.nativeEvent), style: headerStyle },
            title,
            description,
...
class SurveyQuestionSigleInputSummary extends ReactSurveyElement {
    ...
    renderItems() {
        return (reactExports.createElement("div", { className: this.css.summary }, this.summary.items.map((item, index) => this.renderItem(item, index))));
    }
    renderNoItems() {
        ...
        return placeholder || reactExports.createElement("div", null, this.renderLocString(this.summary.noEntry));
    }
    renderItem(item, index) {
        const btnEdit = item.btnEdit ?
            reactExports.createElement("button", { className: this.css.summaryRowActionEdit, onClick: () => item.btnEdit.action(), title: item.btnEdit.title },
                reactExports.createElement(SvgIcon, { iconName: "icon-editsmall-16x16", iconSize: "auto" })) : null;
        const btnDelete = item.showRemove && item.btnRemove ?
            reactExports.createElement("button", { className: this.css.summaryRowActionDelete, onClick: () => item.btnRemove.action(), title: item.btnRemove.title },
                reactExports.createElement(SvgIcon, { iconName: "icon-delete-16x16", iconSize: "auto" })) : null;
        return reactExports.createElement("div", { className: this.css.summaryRow, key: index },
            reactExports.createElement("div", { className: this.css.summaryRowContent }, this.renderLocString(item.locText)),
            reactExports.createElement("div", { className: this.css.summaryRowActions },
                btnEdit,
                btnDelete));
    }
}
ReactElementFactory.Instance.registerElement("sv-singleinput-summary", (props) => {
    return reactExports.createElement(SurveyQuestionSigleInputSummary, props);
});
...
class SurveyBreadcrumbs extends SurveyElementBase {
    ...
    renderElement() {
        if (!this.items || !this.items.length)
            return null;
        const items = this.renderItems();
        return (reactExports.createElement("div", { className: this.css.breadcrumbsRoot }, items));
    }
    renderItems() {
        const result = [];
        this.items.concat([]).forEach((item, itemIndex) => {
            if (itemIndex) {
                result.push(reactExports.createElement(SvgIcon, { key: item.renderedId + "_separator", className: this.css.breadcrumbsSeparator, iconName: "arrowright-16x16", size: "auto" }));
            }
            result.push(reactExports.createElement(SurveyAction, { key: item.renderedId, item: item }));
        });
        return result;
    }
}
ReactElementFactory.Instance.registerElement("sv-breadcrumbs", (props) => {
    return reactExports.createElement(SurveyBreadcrumbs, props);
});
...
class SurveyQuestion extends SurveyElementBase {
    static renderQuestionBody(creator, question) {
        ...
        return reactExports.createElement(SurveyCustomWidget, { creator: creator, question: question });
    }
    constructor(props) {
        super(props);
    ...
    renderQuestionContent() {
        ...
        var descriptionUnderInput = question.hasDescriptionUnderInput
            ...
            : null;
        return (reactExports.createElement("div", { className: question.cssContent || undefined, style: contentStyle, "aria-hidden": question.contentAriaHidden, role: "presentation" },
            questionRender,
            comment,
    ...
    renderElement() {
        ...
        return (reactExports.createElement(reactExports.Fragment, null,
            reactExports.createElement("div", { ref: this.rootRef, id: question.id, className: question.getRootCss(), style: rootStyle, "data-name": question.name, role: question.ariaRole, "aria-required": this.question.ariaRequired, "aria-invalid": this.question.ariaInvalid, "aria-label": this.question.ariaLabel, "aria-labelledby": question.ariaLabelledBy, "aria-describedby": question.ariaDescribedBy, "aria-expanded": question.ariaExpanded },
                singleBreadcrumbs,
                errorsAboveQuestion,
                headerTop,
                questionContent,
    ...
    renderSingleInputQuestion(question, cssClasses) {
        ...
        return reactExports.createElement(SurveyQuestion, { key: key, element: singleQuestion, creator: this.creator, css: cssClasses });
    }
    renderSingleInputBreadcrumbs(question, cssClasses) {
        return reactExports.createElement(SurveyBreadcrumbs, { model: question.singleInputActions, css: cssClasses });
    }
    renderSingleInputSummary(question, cssClasses) {
        return reactExports.createElement(SurveyQuestionSigleInputSummary, { summary: question.singleInputSummary, creator: this.creator, css: cssClasses });
    }
    wrapElement(element) {
    ...
    renderComment(cssClasses) {
        ...
        return (reactExports.createElement("div", { className: this.question.getCommentAreaCss() },
            reactExports.createElement("div", null, commentText),
            reactExports.createElement(SurveyQuestionCommentItem, { question: this.question, cssClasses: cssClasses, isDisplayMode: this.question.isInputReadOnly })));
    }
    renderHeader(question) {
        if (question.singleInputHideHeader)
            return null;
        return reactExports.createElement(SurveyElementHeader, { element: question });
    }
    renderErrors(cssClasses, location) {
        return (reactExports.createElement(SurveyElementErrors, { element: this.question, cssClasses: cssClasses, creator: this.creator, location: location, id: this.question.id + "_errors" }));
    }
}
ReactElementFactory.Instance.registerElement("question", (props) => {
    return reactExports.createElement(SurveyQuestion, props);
});
class SurveyElementErrors extends ReactSurveyElement {
    ...
    renderElement() {
        ...
        return (reactExports.createElement("div", { className: this.element.cssError, id: this.id }, errors));
    }
}
class SurveyQuestionAndErrorsWrapped extends ReactSurveyElement {
    ...
    renderContent() {
        ...
        return (reactExports.createElement(reactExports.Fragment, null, renderedQuestion));
    }
    getShowErrors() {
...
class SurveyQuestionAndErrorsCell extends SurveyQuestionAndErrorsWrapped {
    constructor(props) {
        super(props);
        this.cellRef = reactExports.createRef();
    }
    componentWillUnmount() {
        super.componentWillUnmount();
        if (this.question) {
    ...
    renderCellContent() {
        return (reactExports.createElement("div", { className: this.props.cell.cellQuestionWrapperClassName }, this.renderQuestion()));
    }
    renderElement() {
        var style = this.getCellStyle();
        const cell = this.props.cell;
        const focusIn = () => { cell.focusIn(); };
        return (reactExports.createElement("td", { ref: this.cellRef, className: this.itemCss, colSpan: cell.colSpans, title: cell.getTitle(), style: style, onFocus: focusIn }, this.wrapCell(this.props.cell, this.renderCellContent())));
    }
    getCellStyle() {
        return null;
    }
...
class SurveyQuestionErrorCell extends reactExports.Component {
    constructor(props) {
        super(props);
        this.state = {
            changed: 0
    ...
    render() {
        return reactExports.createElement(SurveyElementErrors, { element: this.question, creator: this.props.creator, cssClasses: this.question.cssClasses });
    }
}
...
class SurveyPage extends SurveyPanelBase {
    ...
    renderElement() {
        ...
        const errors = (reactExports.createElement(SurveyElementErrors, { element: this.panelBase, cssClasses: this.panelBase.cssClasses, creator: this.creator }));
        return (reactExports.createElement("div", { ref: this.rootRef, className: this.page.cssRoot },
            title,
            description,
            errors,
            rows));
    ...
    renderTitle() {
        return reactExports.createElement(TitleElement, { element: this.page });
    }
    renderDescription() {
        if (!this.page._showDescription)
            return null;
        var text = SurveyElementBase.renderLocString(this.page.locDescription);
        return (reactExports.createElement("div", { className: this.panelBase.cssClasses.page.description }, text));
    }
}

class SurveyHeader extends reactExports.Component {
    constructor(props) {
        super(props);
    ...
    renderTitle() {
        ...
        return (reactExports.createElement("div", { className: this.css.headerText, style: { maxWidth: this.survey.titleMaxWidth } },
            reactExports.createElement(TitleElement, { element: this.survey }),
            this.survey.renderedHasDescription ? reactExports.createElement("div", { className: this.css.description }, description) : null));
    }
    ...
    render() {
        if (!this.survey.renderedHasHeader)
            return null;
        return (reactExports.createElement("div", { className: this.css.header, ref: this.rootRef },
            this.renderLogoImage(this.survey.isLogoBefore),
            this.renderTitle(),
            this.renderLogoImage(this.survey.isLogoAfter),
            reactExports.createElement("div", { className: this.css.headerClose })));
    }
}
ReactElementFactory.Instance.registerElement("survey-header", (props) => {
    return reactExports.createElement(SurveyHeader, props);
});

class BrandInfo extends reactExports.Component {
    render() {
        return (reactExports.createElement("div", { className: "sv-brand-info" },
            reactExports.createElement("a", { className: "sv-brand-info__logo", href: "https://surveyjs.io/?utm_source=built-in_links&utm_medium=online_survey_tool&utm_campaign=landing_page" },
                reactExports.createElement("img", { src: "https://surveyjs.io/Content/Images/poweredby.svg" })),
            reactExports.createElement("div", { className: "sv-brand-info__text" },
                "Try and see how easy it is to ",
                reactExports.createElement("a", { href: "https://surveyjs.io/create-survey?utm_source=built-in_links&utm_medium=online_survey_tool&utm_campaign=create_survey" }, "create a survey")),
            reactExports.createElement("div", { className: "sv-brand-info__terms" },
                reactExports.createElement("a", { href: "https://surveyjs.io/TermsOfUse" }, "Terms of Use & Privacy Statement"))));
    }
}
...
class NotifierComponent extends SurveyElementBase {
    ...
    renderElement() {
        ...
        return (reactExports.createElement("div", { className: this.notifier.css, style: style, role: "alert", "aria-live": "polite" },
            reactExports.createElement("span", null, this.notifier.message),
            reactExports.createElement(SurveyActionBar, { model: this.notifier.actionBar })));
    }
}
ReactElementFactory.Instance.registerElement("sv-notifier", (props) => {
    return reactExports.createElement(NotifierComponent, props);
});

class ComponentsContainer extends reactExports.Component {
    render() {
        ...
        if (!needRenderWrapper) {
            return reactExports.createElement(reactExports.Fragment, null, components.map(component => {
        ...
        return reactExports.createElement("div", { className: "sv-components-column" + " sv-components-container-" + this.props.container }, components.map(component => {
            return ReactElementFactory.Instance.createElement(component.component, { survey: this.props.survey, model: component.data, container: this.props.container, key: component.id });
        }));
    }
}
ReactElementFactory.Instance.registerElement("sv-components-container", (props) => {
    return reactExports.createElement(ComponentsContainer, props);
});

class SvgBundleComponent extends reactExports.Component {
    constructor(props) {
        super(props);
        this.onIconsChanged = () => {
    ...
    render() {
        ...
        return reactExports.createElement("svg", { style: svgStyle, id: "sv-icon-holder-global-container", ref: this.containerRef });
    }
}
...
class PopupModal extends SurveyElementBase {
    ...
    renderElement() {
        if (!this.model)
            return null;
        return reactDomExports.createPortal(reactExports.createElement(PopupContainer, { model: this.model }), this.model.container);
    }
...
class Scroll extends reactExports.Component {
    constructor(props) {
        super(props);
        this.rootRef = reactExports.createRef();
    ...
    render() {
        return this.props.disabled ?
            reactExports.createElement(reactExports.Fragment, null, this.props.children) :
            reactExports.createElement("div", { ref: this.rootRef, className: "sv-scroll__wrapper" },
                reactExports.createElement("div", { className: "sv-scroll__scroller sv-drag-target-skipped", onScroll: () => this.model.onScrollContainer() },
                    reactExports.createElement("div", { className: "sv-scroll__container" }, this.props.children)),
                reactExports.createElement("div", { className: "sv-scroll__scrollbar", onScroll: () => this.model.onScrollScrollbar() },
                    reactExports.createElement("div", { className: "sv-scroll__scrollbar-sizer" })));
    }
}
ReactElementFactory.Instance.registerElement("svc-scroll", (props) => {
    return reactExports.createElement(Scroll, props);
});
...
class Survey extends SurveyElementBase {
    ...
    doRender() {
        ...
        const backgroundImage = !!this.survey.backgroundImage ? reactExports.createElement("div", { className: this.css.rootBackgroundImage, style: this.survey.backgroundImageStyle }) : null;
        const header = this.survey.headerView === "basic" ? reactExports.createElement(SurveyHeader, { survey: this.survey }) : null;
        const onSubmit = function (event) {
            event.preventDefault();
        };
        let customHeader = reactExports.createElement("div", { className: "sv_custom_header" });
        ...
        return (reactExports.createElement("div", { id: this.rootNodeId, ref: this.rootRef, className: cssClasses, style: this.survey.themeVariables, lang: this.survey.locale || "en", dir: this.survey.localeDir },
            reactExports.createElement(Scroll, { disabled: this.survey.rootScrollDisabled },
                this.survey.needRenderIcons ? reactExports.createElement(SvgBundleComponent, null) : null,
                reactExports.createElement(PopupModal, null),
                reactExports.createElement("div", { className: this.survey.wrapperFormCss },
                    backgroundImage,
                    reactExports.createElement("form", { onSubmit: onSubmit },
                        reactExports.createElement(Scroll, { disabled: this.survey.formScrollDisabled },
                            customHeader,
                            reactExports.createElement("div", { className: this.css.container },
                                header,
                                reactExports.createElement(ComponentsContainer, { survey: this.survey, container: "header", needRenderWrapper: false }),
                                renderResult,
                                reactExports.createElement(ComponentsContainer, { survey: this.survey, container: "footer", needRenderWrapper: false })))),
                    reactExports.createElement(NotifierComponent, { notifier: this.survey.notifier })))));
    }
    renderElement() {
    ...
    renderCompleted() {
        ...
        return (reactExports.createElement(reactExports.Fragment, null,
            reactExports.createElement("div", { dangerouslySetInnerHTML: htmlValue, className: this.survey.completedCss }),
            reactExports.createElement(ComponentsContainer, { survey: this.survey, container: "completePage", needRenderWrapper: false })));
    }
    renderCompletedBefore() {
        var htmlValue = { __html: this.survey.processedCompletedBeforeHtml };
        return (reactExports.createElement("div", { dangerouslySetInnerHTML: htmlValue, className: this.survey.completedBeforeCss }));
    }
    renderLoading() {
        var htmlValue = { __html: this.survey.processedLoadingHtml };
        return (reactExports.createElement("div", { dangerouslySetInnerHTML: htmlValue, className: this.survey.loadingBodyCss }));
    }
    renderSurvey() {
        ...
        return (reactExports.createElement("div", { className: this.survey.bodyContainerCss },
            reactExports.createElement(ComponentsContainer, { survey: this.survey, container: "left" }),
            reactExports.createElement("div", { className: "sv-components-column sv-components-column--expandable" },
                reactExports.createElement(ComponentsContainer, { survey: this.survey, container: "center" }),
                reactExports.createElement("div", { id: pageId, className: className, style: style },
                    reactExports.createElement(ComponentsContainer, { survey: this.survey, container: "contentTop" }),
                    activePage,
                    reactExports.createElement(ComponentsContainer, { survey: this.survey, container: "contentBottom" }),
                    this.survey.showBrandInfo ? reactExports.createElement(BrandInfo, null) : null)),
            reactExports.createElement(ComponentsContainer, { survey: this.survey, container: "right" })));
    }
    renderPage(page) {
        return (reactExports.createElement(SurveyPage, { survey: this.survey, page: page, css: this.css, creator: this }));
    }
    renderEmptySurvey() {
        return reactExports.createElement("div", { className: this.css.bodyEmpty }, this.survey.emptySurveyText);
    }
...
ReactElementFactory.Instance.registerElement("survey", (props) => {
    return reactExports.createElement(Survey, props);
});
function attachKey2click(element, viewModel, options = { processEsc: true, disableTabStop: false }) {
    if ((!!viewModel && viewModel.disableTabStop) || (!!options && options.disableTabStop)) {
        return reactExports.cloneElement(element, { tabIndex: -1 });
    }
...
class SurveyTimerPanel extends ReactSurveyElement {
    ...
    render() {
        ...
        let result = reactExports.createElement("div", { className: this.timerModel.survey.getCss().timerRoot }, this.timerModel.text);
        if (this.timerModel.showTimerAsClock) {
            let style = { strokeDasharray: this.circleLength, strokeDashoffset: this.progress };
            const progress = (this.timerModel.showProgress ? reactExports.createElement(SvgIcon, { className: this.timerModel.getProgressCss(), style: style, iconName: "icon-timercircle", size: "auto" }) : null);
            result =
                (reactExports.createElement("div", { className: this.timerModel.rootCss },
                    progress,
                    reactExports.createElement("div", { className: this.timerModel.textContainerCss },
                        reactExports.createElement("span", { className: this.timerModel.majorTextCss }, this.timerModel.clockMajorText),
                        (this.timerModel.clockMinorText ? reactExports.createElement("span", { className: this.timerModel.minorTextCss }, this.timerModel.clockMinorText) : null))));
        }
        return result;
    }
}
ReactElementFactory.Instance.registerElement("sv-timerpanel", (props) => {
    return reactExports.createElement(SurveyTimerPanel, props);
});
...
class SurveyPanel extends SurveyPanelBase {
    ...
    renderElement() {
        ...
        return (reactExports.createElement("div", { ref: this.rootRef, className: this.panelBase.getContainerCss(), onFocus: focusIn, id: this.panelBase.id },
    ...
    renderHeader() {
        ...
        return reactExports.createElement(SurveyElementHeader, { element: this.panel });
    }
    wrapElement(element) {
    ...
    renderContent(style, rows, className) {
        ...
        return (reactExports.createElement("div", { style: style, className: className, id: this.panel.contentId, role: this.panel.ariaRole, "aria-labelledby": this.panel.ariaLabelledBy, "aria-label": this.panel.ariaLabel },
            rows,
            bottom));
    }
    renderTitle() {
        if (!this.panelBase.title)
            return null;
        return reactExports.createElement(TitleElement, { element: this.panelBase });
    }
    renderDescription() {
        if (!this.panelBase.description)
            return null;
        var text = SurveyElementBase.renderLocString(this.panelBase.locDescription);
        return (reactExports.createElement("div", { className: this.panel.cssClasses.panel.description }, text));
    }
    renderBottom() {
        const footerToolbar = this.panel.getFooterToolbar();
        if (!footerToolbar.hasActions)
            return null;
        return reactExports.createElement(SurveyActionBar, { model: footerToolbar });
    }
    getIsVisible() {
...
ReactElementFactory.Instance.registerElement("panel", (props) => {
    return reactExports.createElement(SurveyPanel, props);
});
...
class SurveyFlowPanel extends SurveyPanel {
    ...
    renderHtml() {
        ...
        if (!DOMParser) {
            ...
            return reactExports.createElement("div", { dangerouslySetInnerHTML: htmlValue });
        }
    ...
    renderParentNode(node) {
        ...
        if (nodeType === "div")
            return reactExports.createElement("div", { key: this.getNodeIndex() }, children);
        return (reactExports.createElement("span", { key: this.getNodeIndex(), style: this.getStyle(nodeType) }, children));
    }
    renderNode(node) {
        ...
        if (nodeType === "question") {
            ...
            if (!question)
                return null;
            const questionBody = (reactExports.createElement(SurveyQuestion, { key: question.name, element: question, creator: this.creator, css: this.css }));
            return reactExports.createElement("span", { key: this.getNodeIndex() }, questionBody);
        }
        if (nodeType === "div") {
            return reactExports.createElement("div", { key: this.getNodeIndex() }, node.textContent);
        }
        return (reactExports.createElement("span", { key: this.getNodeIndex(), style: this.getStyle(nodeType) }, node.textContent));
    }
    ...
    renderContent(style, rows) {
        return reactExports.createElement("f-panel", { style: style }, rows);
    }
}
ReactElementFactory.Instance.registerElement("flowpanel", props => {
    return reactExports.createElement(SurveyFlowPanel, props);
});
...
class SurveyQuestionCheckbox extends SurveyQuestionElementBase {
    ...
    renderElement() {
        ...
        return (reactExports.createElement("fieldset", { className: this.question.getSelectBaseRootCss(), ref: (fieldset) => (this.setControl(fieldset)), role: this.question.a11y_input_ariaRole, "aria-required": this.question.a11y_input_ariaRequired, "aria-label": this.question.a11y_input_ariaLabel, "aria-labelledby": this.question.a11y_input_ariaLabelledBy, "aria-describedby": this.question.a11y_input_ariaDescribedBy, "aria-invalid": this.question.a11y_input_ariaInvalid, "aria-errormessage": this.question.a11y_input_ariaErrormessage },
            reactExports.createElement("legend", { className: "sv-hidden" }, this.question.locTitle.renderedHtml),
            this.getHeader(),
    ...
    getColumnedBody(cssClasses) {
        return (reactExports.createElement("div", { className: cssClasses.rootMultiColumn }, this.getColumns(cssClasses)));
    }
    getColumns(cssClasses) {
        return this.question.columns.map((column, ci) => {
            ...
            return (reactExports.createElement("div", { key: "column" + ci + this.question.getItemsColumnKey(column), className: this.question.getColumnClass(), role: "presentation" }, items));
        });
    }
    getBody(cssClasses) {
        if (this.question.blockedRow) {
            return reactExports.createElement("div", { className: cssClasses.rootRow }, this.getItems(cssClasses, this.question.dataChoices));
        }
        else {
            return reactExports.createElement(reactExports.Fragment, null, this.getItems(cssClasses, this.question.bodyItems));
        }
    }
...
class SurveyQuestionCheckboxItem extends ReactSurveyElement {
    ...
    renderComment() {
        if (!this.item.isCommentShowing)
            return null;
        return reactExports.createElement("div", { className: this.question.getCommentAreaCss(true) },
            reactExports.createElement(SurveyQuestionCommentValueItem, { question: this.question, item: this.item, cssClasses: this.question.cssClasses }));
    }
    renderCheckbox(isChecked, otherItem) {
        ...
        const itemLabel = !this.hideCaption ? reactExports.createElement("span", { className: this.cssClasses.controlLabel }, this.renderLocString(this.item.locText, this.textStyle)) : null;
        return (reactExports.createElement("div", { className: itemClass, role: "presentation", ref: this.rootRef },
            reactExports.createElement("label", { className: labelClass },
                reactExports.createElement("input", { className: this.cssClasses.itemControl, type: "checkbox", name: this.question.name + this.item.id, value: this.item.value, id: id, style: this.inputStyle, disabled: !this.question.getItemEnabled(this.item), readOnly: this.question.isReadOnlyAttr, checked: isChecked, onChange: this.handleOnChange, required: this.question.hasRequiredError(), "aria-label": this.ariaLabel }),
                this.cssClasses.materialDecorator ?
                    reactExports.createElement("span", { className: this.cssClasses.materialDecorator }, this.question.itemSvgIcon ?
                        reactExports.createElement("svg", { className: this.cssClasses.itemDecorator },
                            reactExports.createElement("use", { xlinkHref: this.question.itemSvgIcon })) :
                        null) :
                    null,
                itemLabel),
            otherItem));
...
ReactElementFactory.Instance.registerElement("survey-checkbox-item", (props) => {
    return reactExports.createElement(SurveyQuestionCheckboxItem, props);
});
ReactQuestionFactory.Instance.registerQuestion("checkbox", (props) => {
    return reactExports.createElement(SurveyQuestionCheckbox, props);
});
...
class SurveyQuestionRanking extends SurveyQuestionElementBase {
    ...
    renderElement() {
        if (!this.question.selectToRankEnabled) {
            return (reactExports.createElement("div", { className: this.question.rootClass, ref: (root) => (this.setControl(root)) }, this.getItems()));
        }
        else {
            const unrankedItem = true;
            return (reactExports.createElement("div", { className: this.question.rootClass, ref: (root) => (this.setControl(root)) },
                reactExports.createElement("div", { className: this.question.getContainerClasses("from"), "data-ranking": "from-container" },
                    this.getItems(this.question.renderedUnRankingChoices, unrankedItem),
                    this.question.renderedUnRankingChoices.length === 0 ? reactExports.createElement("div", { className: this.question.cssClasses.containerPlaceholder },
                        " ",
                        this.renderLocString(this.question.locSelectToRankEmptyRankedAreaText),
                        " ") : null),
                reactExports.createElement("div", { className: this.question.cssClasses.containersDivider }),
                reactExports.createElement("div", { className: this.question.getContainerClasses("to"), "data-ranking": "to-container" },
                    this.getItems(),
                    this.question.renderedRankingChoices.length === 0 ? reactExports.createElement("div", { className: this.question.cssClasses.containerPlaceholder },
                        " ",
...
class SurveyQuestionRankingItem extends ReactSurveyElement {
    ...
    renderEmptyIcon() {
        return (reactExports.createElement("svg", null,
            reactExports.createElement("use", { xlinkHref: this.question.dashSvgIcon })));
    }
    renderElement() {
        ...
        return (reactExports.createElement("div", { id: this.question.getItemId(this.item), tabIndex: this.itemTabIndex, className: this.itemClass, onKeyDown: this.handleKeydown, onPointerDown: this.handlePointerDown, onPointerUp: this.handlePointerUp, "data-sv-drop-target-ranking-item": this.index },
            reactExports.createElement("div", { tabIndex: -1, style: { outline: "none" } },
                reactExports.createElement("div", { className: this.cssClasses.itemGhostNode }),
                reactExports.createElement("div", { className: this.cssClasses.itemContent },
                    reactExports.createElement("div", { className: this.cssClasses.itemIconContainer },
                        reactExports.createElement("svg", { className: this.question.getIconHoverCss() },
                            reactExports.createElement("use", { xlinkHref: this.question.dragDropSvgIcon })),
                        reactExports.createElement("svg", { className: this.question.getIconFocusCss() },
                            reactExports.createElement("use", { xlinkHref: this.question.arrowsSvgIcon }))),
                    reactExports.createElement("div", { className: this.question.getItemIndexClasses(this.item) }, (!this.unrankedItem && this.indexText) ? this.indexText : this.renderEmptyIcon()),
                    itemContent))));
    }
}
class SurveyQuestionRankingItemContent extends ReactSurveyElement {
    ...
    renderElement() {
        return reactExports.createElement("div", { className: this.cssClasses.controlLabel }, SurveyElementBase.renderLocString(this.item.locText));
    }
}
ReactElementFactory.Instance.registerElement("sv-ranking-item", props => {
    return reactExports.createElement(SurveyQuestionRankingItemContent, props);
});
ReactQuestionFactory.Instance.registerQuestion("ranking", (props) => {
    return reactExports.createElement(SurveyQuestionRanking, props);
});
...
class RatingItem extends RatingItemBase {
    render() {
        ...
        return (reactExports.createElement("label", { onMouseDown: this.handleOnMouseDown, className: this.question.getItemClassByText(this.item.itemValue, this.item.text) },
            reactExports.createElement("input", { type: "radio", className: "sv-visuallyhidden", name: this.question.questionName, id: this.question.getInputId(this.index), value: this.item.value, disabled: this.question.isDisabledAttr, readOnly: this.question.isReadOnlyAttr, checked: this.question.value == this.item.value, onClick: this.props.handleOnClick, onChange: () => { }, "aria-label": this.question.ariaLabel }),
            reactExports.createElement("span", { className: this.question.cssClasses.itemText, "data-text": this.item.text }, itemText)));
    }
    componentDidMount() {
        super.componentDidMount();
    }
...
ReactElementFactory.Instance.registerElement("sv-rating-item", (props) => {
    return reactExports.createElement(RatingItem, props);
});

class RatingItemStar extends RatingItemBase {
    render() {
        return (reactExports.createElement("label", { onMouseDown: this.handleOnMouseDown, className: this.question.getItemClass(this.item.itemValue), onMouseOver: e => this.question.onItemMouseIn(this.item), onMouseOut: e => this.question.onItemMouseOut(this.item), title: this.item.text },
            reactExports.createElement("input", { type: "radio", className: "sv-visuallyhidden", name: this.question.questionName, id: this.question.getInputId(this.index), value: this.item.value, disabled: this.question.isDisabledAttr, readOnly: this.question.isReadOnlyAttr, checked: this.question.value == this.item.value, onClick: this.props.handleOnClick, onChange: () => { }, "aria-label": this.question.ariaLabel }),
            reactExports.createElement(SvgIcon, { className: "sv-star", size: "auto", iconName: this.question.itemStarIcon }),
            reactExports.createElement(SvgIcon, { className: "sv-star-2", size: "auto", iconName: this.question.itemStarIconAlt })));
    }
}
ReactElementFactory.Instance.registerElement("sv-rating-item-star", (props) => {
    return reactExports.createElement(RatingItemStar, props);
});

class RatingItemSmiley extends RatingItemBase {
    render() {
        return (reactExports.createElement("label", { onMouseDown: this.handleOnMouseDown, style: this.question.getItemStyle(this.item.itemValue, this.item.highlight), className: this.question.getItemClass(this.item.itemValue), onMouseOver: e => this.question.onItemMouseIn(this.item), onMouseOut: e => this.question.onItemMouseOut(this.item), title: this.item.text },
            reactExports.createElement("input", { type: "radio", className: "sv-visuallyhidden", name: this.question.questionName, id: this.question.getInputId(this.index), value: this.item.value, disabled: this.question.isDisabledAttr, readOnly: this.question.isReadOnlyAttr, checked: this.question.value == this.item.value, onClick: this.props.handleOnClick, onChange: () => { }, "aria-label": this.question.ariaLabel }),
            reactExports.createElement(SvgIcon, { size: "auto", iconName: this.question.getItemSmileyIconName(this.item.itemValue) })));
    }
}
ReactElementFactory.Instance.registerElement("sv-rating-item-smiley", (props) => {
    return reactExports.createElement(RatingItemSmiley, props);
});
...
class RatingDropdownItem extends SurveyElementBase {
    ...
    render() {
        ...
        return (reactExports.createElement("div", { className: "sd-rating-dropdown-item" },
            reactExports.createElement("span", { className: "sd-rating-dropdown-item_text" }, item.title),
            description));
    }
    renderDescription(item) {
        if (!item.description)
            return null;
        return (reactExports.createElement("div", { className: "sd-rating-dropdown-item_description" }, this.renderLocString(item.description, undefined, "locString")));
    }
}
ReactElementFactory.Instance.registerElement("sv-rating-dropdown-item", (props) => {
    return reactExports.createElement(RatingDropdownItem, props);
});
...
class TagboxFilterString extends SurveyElementBase {
    ...
    render() {
        return (reactExports.createElement("div", { className: this.question.cssClasses.hint },
            this.model.showHintPrefix ?
                (reactExports.createElement("div", { className: this.question.cssClasses.hintPrefix },
                    reactExports.createElement("span", null, this.model.hintStringPrefix))) : null,
            reactExports.createElement("div", { className: this.question.cssClasses.hintSuffixWrapper },
                this.model.showHintString ?
                    (reactExports.createElement("div", { className: this.question.cssClasses.hintSuffix },
                        reactExports.createElement("span", { style: { visibility: "hidden" }, "data-bind": "text: model.filterString" }, this.model.inputStringRendered),
                        reactExports.createElement("span", null, this.model.hintStringSuffix))) : null,
                reactExports.createElement("input", { type: "text", autoComplete: "off", id: this.question.getInputId(), inputMode: this.model.inputMode, ref: (element) => (this.inputElement = element), className: this.question.cssClasses.filterStringInput, disabled: this.question.isInputReadOnly, readOnly: this.model.filterReadOnly ? true : undefined, size: !this.model.inputStringRendered ? 1 : undefined, role: this.model.ariaInputRole, "aria-required": this.model.ariaInputRequired, "aria-invalid": this.model.ariaInputInvalid, "aria-errormessage": this.model.ariaInputErrorMessage, "aria-expanded": this.model.ariaInputExpanded, "aria-label": this.model.ariaInputLabel, "aria-labelledby": this.model.ariaInputLabelledby, "aria-describedby": this.model.ariaInputDescribedby, "aria-controls": this.model.ariaInputControls, "aria-activedescendant": this.model.ariaInputActivedescendant, placeholder: this.model.filterStringPlaceholder, onKeyDown: (e) => { this.keyhandler(e); }, onChange: (e) => { this.onChange(e); }, onBlur: (e) => { this.onBlur(e); }, onFocus: (e) => { this.onFocus(e); } }))));
    }
}
ReactQuestionFactory.Instance.registerQuestion("sv-tagbox-filter", (props) => {
    return reactExports.createElement(TagboxFilterString, props);
});
...
class SurveyQuestionOptionItem extends ReactSurveyElement {
    ...
    renderElement() {
        return (reactExports.createElement("option", { value: this.item.value, disabled: !this.item.isEnabled }, this.item.text));
    }
}
...
class SurveyQuestionDropdownBase extends SurveyQuestionUncontrolledElement {
    ...
    renderReadOnlyElement() {
        if (this.question.locReadOnlyText) {
            return (reactExports.createElement("div", { className: this.question.cssClasses.controlValue }, this.renderLocString(this.question.locReadOnlyText)));
        }
        else {
            return null;
        }
    ...
    renderInput() {
        ...
        return (reactExports.createElement("div", { id: this.question.inputId, className: this.question.getControlClass(), tabIndex: dropdownListModel.noTabIndex ? undefined : 0, 
            // eslint-disable-next-line @typescript-eslint/ban-ts-comment
            // @ts-ignore
            ...
            dropdownListModel.showHintPrefix ?
                (reactExports.createElement("div", { className: this.question.cssClasses.hintPrefix },
                    reactExports.createElement("span", null, dropdownListModel.hintStringPrefix))) : null,
            reactExports.createElement("div", { className: this.question.cssClasses.controlValue },
                dropdownListModel.showHintString ?
                    (reactExports.createElement("div", { className: this.question.cssClasses.hintSuffix },
                        reactExports.createElement("span", { style: { visibility: "hidden" }, "data-bind": "text: model.filterString" }, dropdownListModel.inputStringRendered),
                        reactExports.createElement("span", null, dropdownListModel.hintStringSuffix))) : null,
                valueElement,
...
class SurveyQuestionDropdown extends SurveyQuestionDropdownBase {
    ...
    renderElement() {
        ...
        return (reactExports.createElement("div", { className: this.question.renderCssRoot },
            select,
            comment));
    }
}
ReactQuestionFactory.Instance.registerQuestion("dropdown", (props) => {
    return reactExports.createElement(SurveyQuestionDropdown, props);
});
...
class SurveyQuestionTagboxItem extends ReactSurveyElement {
    ...
    renderElement() {
        ...
        return (reactExports.createElement("div", { className: "sv-tagbox__item" },
            reactExports.createElement("div", { className: "sv-tagbox__item-text" }, text),
            reactExports.createElement("div", { className: this.question.cssClasses.cleanItemButton, onClick: removeItem },
                reactExports.createElement(SvgIcon, { className: this.question.cssClasses.cleanItemButtonSvg, iconName: this.question.cssClasses.cleanItemButtonIconId, size: "auto" }))));
    }
}
...
class SurveyQuestionTagbox extends SurveyQuestionDropdownBase {
    ...
    renderItem(key, item) {
        const renderedItem = (reactExports.createElement(SurveyQuestionTagboxItem, { key: key, question: this.question, item: item }));
        return renderedItem;
    }
    renderInput() {
        const dropdownListModel = this.dropdownListModel;
        ...
        return (reactExports.createElement("div", { id: this.question.inputId, className: this.question.getControlClass(), tabIndex: dropdownListModel.noTabIndex ? undefined : 0, 
            ...
            reactExports.createElement("div", { className: this.question.cssClasses.controlValue },
                items,
                dropdownListModel.needRenderInput ? reactExports.createElement(TagboxFilterString, { model: dropdownListModel, question: this.question }) : null),
            this.renderEditorButtons()));
    }
    renderElement() {
        const cssClasses = this.question.cssClasses;
...
ReactQuestionFactory.Instance.registerQuestion("tagbox", (props) => {
    return reactExports.createElement(SurveyQuestionTagbox, props);
});
...
class SurveyQuestionDropdownSelect extends SurveyQuestionDropdown {
    ...
    renderSelect(cssClasses) {
        ...
        // eslint-disable-next-line @typescript-eslint/ban-ts-comment
        // @ts-ignore
        reactExports.createElement("div", { id: this.question.inputId, className: this.question.getControlClass(), disabled: true }, this.question.readOnlyText)) :
            (reactExports.createElement("select", { id: this.question.inputId, className: this.question.getControlClass(), ref: (select) => (this.setControl(select)), autoComplete: this.question.autocomplete, onChange: this.updateValueOnEvent, onInput: this.updateValueOnEvent, onClick: click, onKeyUp: keyup, "aria-required": this.question.a11y_input_ariaRequired, "aria-label": this.question.a11y_input_ariaLabel, "aria-invalid": this.question.a11y_input_ariaInvalid, "aria-errormessage": this.question.a11y_input_ariaErrormessage, required: this.question.isRequired },
                this.question.allowClear ? (reactExports.createElement("option", { value: "" }, this.question.placeholder)) : null,
                this.question.visibleChoices.map((item, i) => reactExports.createElement(SurveyQuestionOptionItem, { key: "item" + i, item: item }))));
        return (reactExports.createElement("div", { className: cssClasses.selectWrapper },
            selectElement,
    ...
    createChevronButton() {
        if (!this.question.cssClasses.chevronButtonIconId)
            return null;
        return (reactExports.createElement("div", { className: this.question.cssClasses.chevronButton, "aria-hidden": "true", onPointerDown: this.chevronPointerDown },
            reactExports.createElement(SvgIcon, { className: this.question.cssClasses.chevronButtonSvg, iconName: this.question.cssClasses.chevronButtonIconId, size: "auto" })));
    }
}
ReactQuestionFactory.Instance.registerQuestion("sv-dropdown-select", (props) => {
    return reactExports.createElement(SurveyQuestionDropdownSelect, props);
});
...
class SurveyQuestionMatrix extends SurveyQuestionElementBase {
    ...
    renderElement() {
        var cssClasses = this.question.cssClasses;
        var rowsTH = this.question.hasRows ? reactExports.createElement("td", null) : null;
        var headers = [];
        for (var i = 0; i < this.question.visibleColumns.length; i++) {
            ...
            headers.push(reactExports.createElement("th", { className: this.question.cssClasses.headerCell, style: style, key: key }, this.wrapCell({ column: column }, columText, "column-header")));
        }
        var rows = [];
        ...
        for (var i = 0; i < visibleRows.length; i++) {
            ...
            rows.push(reactExports.createElement(SurveyQuestionMatrixRow, { key: key, question: this.question, cssClasses: cssClasses, row: row, isFirst: i == 0 }));
        }
        var header = !this.question.showHeader ? null : (reactExports.createElement("thead", { role: "presentation" },
            reactExports.createElement("tr", null,
                rowsTH,
                headers)));
        return (reactExports.createElement("div", { className: cssClasses.tableWrapper, ref: root => (this.setControl(root)) },
            reactExports.createElement("fieldset", { role: "radiogroup" },
                reactExports.createElement("legend", { className: "sv-visuallyhidden" }, this.question.locTitle.renderedHtml),
                reactExports.createElement("table", { className: this.question.getTableCss(), role: "presentation" },
                    header,
                    reactExports.createElement("tbody", null, rows)))));
    }
}
class SurveyQuestionMatrixRow extends ReactSurveyElement {
    ...
    renderElement() {
        ...
        if (this.question.hasRows) {
            ...
            rowsTD = reactExports.createElement("td", { style: style, className: this.row.rowTextClasses }, this.wrapCell({ row: this.row }, rowText, "row-header"));
        }
        var tds = this.generateTds();
        return (reactExports.createElement("tr", { className: this.row.rowClasses || undefined },
            rowsTD,
            tds));
    }
    generateTds() {
        ...
        for (var i = 0; i < this.question.visibleColumns.length; i++) {
            ...
            if (this.question.hasCellText) {
                ...
                td = (reactExports.createElement("td", { key: key, className: itemClass, onClick: getHandler ? getHandler(column) : () => { } }, this.renderLocString(this.question.getCellDisplayLocText(row.name, column))));
            }
            else {
                ...
                td = (reactExports.createElement("td", { key: key, "data-responsive-title": column.locText.renderedHtml, className: this.question.cssClasses.cell }, renderedCell));
            }
            tds.push(td);
        }
        return tds;
...
class SurveyQuestionMatrixCell extends ReactSurveyElement {
    ...
    renderElement() {
        ...
        const mobileSpan = this.question.isMobile ?
            (reactExports.createElement("span", { className: this.question.cssClasses.cellResponsiveTitle }, this.renderLocString(this.column.locText)))
            : undefined;
        return (reactExports.createElement("label", { onMouseDown: this.handleOnMouseDown, className: itemClass },
            this.renderInput(inputId, isChecked),
            reactExports.createElement("span", { className: this.question.cssMaterialDecorator }, itemSvgIcon ?
                reactExports.createElement("svg", { className: this.question.cssItemDecorator },
                    reactExports.createElement("use", { xlinkHref: itemSvgIcon })) : null),
            mobileSpan));
    }
    renderInput(inputId, isChecked) {
        return (reactExports.createElement("input", { id: inputId, type: this.question.checkType, className: this.question.cssItemValue, name: this.row.fullName, value: this.column.value, disabled: this.row.isDisabledAttr, readOnly: this.row.isReadOnlyAttr, checked: isChecked, onChange: this.handleOnChange, "aria-required": this.question.a11y_input_ariaRequired, "aria-label": this.question.getCellAriaLabel(this.row, this.column), "aria-invalid": this.question.a11y_input_ariaInvalid, "aria-errormessage": this.question.a11y_input_ariaErrormessage }));
    }
}
ReactElementFactory.Instance.registerElement("survey-matrix-cell", props => {
    return reactExports.createElement(SurveyQuestionMatrixCell, props);
});
ReactQuestionFactory.Instance.registerQuestion("matrix", props => {
    return reactExports.createElement(SurveyQuestionMatrix, props);
});
...
class SurveyQuestionHtml extends SurveyQuestionElementBase {
    ...
    renderElement() {
        ...
        return (reactExports.createElement("div", { className: this.question.renderCssRoot, dangerouslySetInnerHTML: htmlValue }));
    }
}
ReactQuestionFactory.Instance.registerQuestion("html", (props) => {
    return reactExports.createElement(SurveyQuestionHtml, props);
});

class LoadingIndicatorComponent extends reactExports.Component {
    render() {
        return (reactExports.createElement("div", { className: "sd-loading-indicator" },
            reactExports.createElement(SvgIcon, { iconName: "icon-loading", size: "auto" })));
    }
}
...
class SurveyQuestionFile extends SurveyQuestionElementBase {
    ...
    renderElement() {
        ...
        return (reactExports.createElement("div", { className: this.question.fileRootCss, ref: el => (this.setContent(el)) },
            fileInput,
            reactExports.createElement("div", { className: this.question.cssClasses.dragArea, onDrop: this.question.onDrop, onDragOver: this.question.onDragOver, onDragLeave: this.question.onDragLeave, onDragEnter: this.question.onDragEnter },
                fileDecorator,
                loadingIndicator,
                video,
                preview,
    ...
    renderFileDecorator() {
        const actionsContainer = this.question.actionsContainerVisible ? reactExports.createElement(SurveyActionBar, { model: this.question.actionsContainer }) : null;
        return (reactExports.createElement("div", { className: this.question.getFileDecoratorCss() },
            this.question.showDragAreaPlaceholder ? reactExports.createElement("span", { className: this.question.cssClasses.dragAreaPlaceholder }, this.renderLocString(this.question.locRenderedPlaceholder)) : false,
            reactExports.createElement("div", { className: this.question.cssClasses.wrapper }, actionsContainer)));
    }
    renderPreview() {
        return ReactElementFactory.Instance.createElement("sv-file-preview", { question: this.question });
    }
    renderLoadingIndicator() {
        return reactExports.createElement("div", { className: this.question.cssClasses.loadingIndicator },
            reactExports.createElement(LoadingIndicatorComponent, null));
    }
    renderVideo() {
        return (reactExports.createElement("div", { className: this.question.cssClasses.videoContainer },
            reactExports.createElement(SurveyAction, { item: this.question.changeCameraAction }),
            reactExports.createElement(SurveyAction, { item: this.question.closeCameraAction }),
            reactExports.createElement("video", { autoPlay: true, playsInline: true, id: this.question.videoId, className: this.question.cssClasses.video }),
            reactExports.createElement(SurveyAction, { item: this.question.takePictureAction })));
    }
}
ReactQuestionFactory.Instance.registerQuestion("file", props => {
    return reactExports.createElement(SurveyQuestionFile, props);
});
...
class SurveyFileChooseButton extends ReactSurveyElement {
    ...
    render() {
        return attachKey2click(reactExports.createElement("label", { tabIndex: 0, className: this.question.getChooseFileCss(), htmlFor: this.question.inputId, "aria-label": this.question.chooseButtonText, onClick: (e) => this.question.chooseFile(e.nativeEvent) },
            (!!this.question.cssClasses.chooseFileIconId) ? reactExports.createElement(SvgIcon, { title: this.question.chooseButtonText, iconName: this.question.cssClasses.chooseFileIconId, size: "auto" }) : null,
            reactExports.createElement("span", null, this.question.chooseButtonText)));
    }
}
ReactElementFactory.Instance.registerElement("sv-file-choose-btn", (props) => {
    return reactExports.createElement(SurveyFileChooseButton, props);
});
...
class SurveyFileItem extends SurveyElementBase {
    ...
    renderFileSign(className, val) {
        if (!className || !val.name)
            return null;
        return (reactExports.createElement("div", { className: className },
            reactExports.createElement("a", { href: val.content, onClick: event => {
                    this.question.doDownloadFile(event, val);
                }, title: val.name, download: val.name, style: { width: this.question.imageWidth } }, val.name)));
    }
    renderElement() {
        const val = this.item;
        return (reactExports.createElement("span", { className: this.question.cssClasses.previewItem, onClick: (event) => this.question.doDownloadFileFromContainer(event) },
            this.renderFileSign(this.question.cssClasses.fileSign, val),
            reactExports.createElement("div", { className: this.question.getImageWrapperCss(val) },
                this.question.canPreviewImage(val) ? (reactExports.createElement("img", { src: val.content, style: { height: this.question.imageHeight, width: this.question.imageWidth }, alt: "File preview" })) : (this.question.cssClasses.defaultImage ? (reactExports.createElement(SvgIcon, { iconName: this.question.cssClasses.defaultImageIconId, size: "auto", className: this.question.cssClasses.defaultImage })) : null),
                val.name && !this.question.isReadOnly ? (reactExports.createElement("div", { className: this.question.getRemoveButtonCss(), onClick: (event) => this.question.doRemoveFile(val, event) },
                    reactExports.createElement("span", { className: this.question.cssClasses.removeFile }, this.question.removeFileCaption),
                    (this.question.cssClasses.removeFileSvgIconId) ?
                        (reactExports.createElement(SvgIcon, { title: this.question.removeFileCaption, iconName: this.question.cssClasses.removeFileSvgIconId, size: "auto", className: this.question.cssClasses.removeFileSvg })) : null)) : null),
...
class SurveyFilePage extends SurveyElementBase {
    ...
    renderElement() {
        const items = this.page.items.map((item, index) => { return (reactExports.createElement(SurveyFileItem, { item: item, question: this.question, key: index })); });
        return (reactExports.createElement("div", { className: this.page.css, id: this.page.id }, items));
    }
}
...
class SurveyFilePreview extends SurveyElementBase {
    ...
    renderElement() {
        const content = this.question.renderedPages.map((page, index) => { return (reactExports.createElement(SurveyFilePage, { page: page, question: this.question, key: page.id })); });
        return reactExports.createElement("div", { className: this.question.cssClasses.fileList || undefined }, content);
    }
    canRender() {
        return this.question.showPreviewContainer;
    }
...
ReactElementFactory.Instance.registerElement("sv-file-preview", (props) => {
    return reactExports.createElement(SurveyFilePreview, props);
});
...
class SurveyQuestionMultipleText extends SurveyQuestionElementBase {
    ...
    renderElement() {
        ...
        return (reactExports.createElement("table", { className: this.question.getQuestionRootCss() },
            reactExports.createElement("tbody", null, rows)));
    }
    renderCell(cell, cssClasses, index) {
        ...
        if (cell.isErrorsCell) {
            cellContent = reactExports.createElement(SurveyQuestionErrorCell, { question: cell.item.editor, creator: this.creator });
        }
        else {
            cellContent = reactExports.createElement(SurveyMultipleTextItem, { question: this.question, item: cell.item, creator: this.creator, cssClasses: cssClasses });
        }
        return (reactExports.createElement("td", { key: "item" + index, className: cell.className, onFocus: focusIn }, cellContent));
    }
    renderRow(rowIndex, cells, cssClasses) {
        ...
        return (reactExports.createElement("tr", { key: key, className: cssClasses.row }, tds));
    }
}
class SurveyMultipleTextItem extends ReactSurveyElement {
    ...
    renderElement() {
        ...
        return (reactExports.createElement("label", { className: this.question.getItemLabelCss(item) },
            reactExports.createElement("span", { className: cssClasses.itemTitle, style: titleStyle },
                reactExports.createElement(TitleContent, { element: item.editor, cssClasses: item.editor.cssClasses })),
            reactExports.createElement(SurveyMultipleTextItemEditor, { cssClasses: cssClasses, itemCss: this.question.getItemCss(), question: item.editor, creator: this.creator })));
    }
}
class SurveyMultipleTextItemEditor extends SurveyQuestionAndErrorsWrapped {
    renderElement() {
        return reactExports.createElement("div", { className: this.itemCss }, this.renderContent());
    }
}
ReactQuestionFactory.Instance.registerQuestion("multipletext", (props) => {
    return reactExports.createElement(SurveyQuestionMultipleText, props);
});
...
class SurveyQuestionRadiogroup extends SurveyQuestionElementBase {
    ...
    renderElement() {
        ...
        if (this.question.showClearButtonInContent) {
            clearButton = (reactExports.createElement("div", null,
                reactExports.createElement("input", { type: "button", className: this.question.cssClasses.clearButton, onClick: () => this.question.clearValue(true), value: this.question.clearButtonCaption })));
        }
        return (reactExports.createElement("fieldset", { className: this.question.getSelectBaseRootCss(), ref: (fieldset) => (this.setControl(fieldset)), role: this.question.a11y_input_ariaRole, "aria-required": this.question.a11y_input_ariaRequired, "aria-label": this.question.a11y_input_ariaLabel, "aria-labelledby": this.question.a11y_input_ariaLabelledBy, "aria-describedby": this.question.a11y_input_ariaDescribedBy, "aria-invalid": this.question.a11y_input_ariaInvalid, "aria-errormessage": this.question.a11y_input_ariaErrormessage },
            this.question.hasColumns
                ? this.getColumnedBody(cssClasses)
...
class SurveyQuestionRadioItem extends ReactSurveyElement {
    ...
    renderRadioButton() {
        ...
        const itemLabel = !this.hideCaption ? reactExports.createElement("span", { className: controlLabelClass }, this.renderLocString(this.item.locText, this.textStyle)) : null;
        return (reactExports.createElement("div", { className: itemClass, role: "presentation", ref: this.rootRef },
            reactExports.createElement("label", { onMouseDown: this.handleOnMouseDown, className: labelClass },
                reactExports.createElement("input", { "aria-errormessage": this.question.ariaErrormessage, className: this.cssClasses.itemControl, id: this.question.getItemId(this.item), type: "radio", name: this.question.questionName, checked: this.isChecked, value: this.item.value, disabled: !this.question.getItemEnabled(this.item), readOnly: this.question.isReadOnlyAttr, onChange: this.handleOnChange, "aria-label": this.ariaLabel }),
                this.cssClasses.materialDecorator ?
                    reactExports.createElement("span", { className: this.cssClasses.materialDecorator }, this.question.itemSvgIcon ?
                        reactExports.createElement("svg", { className: this.cssClasses.itemDecorator },
                            reactExports.createElement("use", { xlinkHref: this.question.itemSvgIcon })) :
...
ReactElementFactory.Instance.registerElement("survey-radiogroup-item", (props) => {
    return reactExports.createElement(SurveyQuestionRadioItem, props);
});
ReactQuestionFactory.Instance.registerQuestion("radiogroup", (props) => {
    return reactExports.createElement(SurveyQuestionRadiogroup, props);
});
...
class SurveyQuestionText extends SurveyQuestionUncontrolledElement {
    ...
    renderInput() {
        ...
        if (this.question.isReadOnlyRenderDiv()) {
            return reactExports.createElement("div", null, this.question.inputValue);
        }
        const counter = !!this.question.getMaxLength() ? (reactExports.createElement(CharacterCounterComponent, { counter: this.question.characterCounter, remainingCharacterCounter: this.question.cssClasses.remainingCharacterCounter })) : null;
        return (reactExports.createElement(reactExports.Fragment, null,
            reactExports.createElement("input", { id: this.question.inputId, 
    ...
    renderDataList() {
        ...
        for (var i = 0; i < items.length; i++) {
            options.push(reactExports.createElement("option", { key: "item" + i, value: items[i] }));
        }
        return reactExports.createElement("datalist", { id: this.question.dataListId }, options);
    }
}
ReactQuestionFactory.Instance.registerQuestion("text", (props) => {
    return reactExports.createElement(SurveyQuestionText, props);
});
...
class SurveyQuestionBoolean extends SurveyQuestionElementBase {
    constructor(props) {
        ...
        this.checkRef = reactExports.createRef();
    }
    getStateElement() {
        return this.question;
    }
    ...
    */
    ...
    renderElement() {
        ...
        return (reactExports.createElement("div", { className: cssClasses.root, onKeyDown: this.handleOnKeyDown },
            reactExports.createElement("label", { className: itemClass },
                reactExports.createElement("input", { ref: this.checkRef, type: "checkbox", name: this.question.name, value: this.question.booleanValue === null
                        ? ""
                ...
                reactExports.createElement("div", { className: cssClasses.sliderGhost, onClick: (event) => this.handleOnLabelClick(event, this.question.swapOrder) },
                    reactExports.createElement("span", { className: this.question.getLabelCss(this.question.swapOrder) }, this.renderLocString(this.question.locLabelLeft))),
                reactExports.createElement("div", { className: cssClasses.switch, onClick: this.handleOnSwitchClick },
                    reactExports.createElement("span", { className: cssClasses.slider }, this.question.isDeterminated && cssClasses.sliderText ?
                        reactExports.createElement("span", { className: cssClasses.sliderText }, this.renderLocString(this.question.getCheckedLabel()))
                        : null)),
                reactExports.createElement("div", { className: cssClasses.sliderGhost, onClick: (event) => this.handleOnLabelClick(event, !this.question.swapOrder) },
                    reactExports.createElement("span", { className: this.question.getLabelCss(!this.question.swapOrder) }, this.renderLocString(this.question.locLabelRight))))));
    }
}
ReactQuestionFactory.Instance.registerQuestion("boolean", (props) => {
    return reactExports.createElement(SurveyQuestionBoolean, props);
});
...
class SurveyQuestionBooleanCheckbox extends SurveyQuestionBoolean {
    ...
    renderElement() {
        ...
        return (reactExports.createElement("div", { className: cssClasses.rootCheckbox },
            reactExports.createElement("div", { className: itemClass },
                reactExports.createElement("label", { className: cssClasses.checkboxLabel },
                    reactExports.createElement("input", { ref: this.checkRef, type: "checkbox", name: this.question.name, value: this.question.booleanValue === null
                            ? ""
                    ...
                    reactExports.createElement("span", { className: cssClasses.checkboxMaterialDecorator },
                        this.question.svgIcon ?
                            reactExports.createElement("svg", { className: cssClasses.checkboxItemDecorator },
                                reactExports.createElement("use", { xlinkHref: this.question.svgIcon })) : null,
                        reactExports.createElement("span", { className: "check" })),
                    this.question.isLabelRendered && (reactExports.createElement("span", { className: cssClasses.checkboxControlLabel, id: this.question.labelRenderedAriaID },
                        reactExports.createElement(TitleActions, { element: this.question, cssClasses: this.question.cssClasses })))),
                description)));
    }
}
ReactQuestionFactory.Instance.registerQuestion("sv-boolean-checkbox", (props) => {
    return reactExports.createElement(SurveyQuestionBooleanCheckbox, props);
});
...
class SurveyQuestionBooleanRadio extends SurveyQuestionBoolean {
    ...
    renderRadioItem(value, locText) {
        const cssClasses = this.question.cssClasses;
        return (reactExports.createElement("div", { role: "presentation", className: this.question.getRadioItemClass(cssClasses, value) },
            reactExports.createElement("label", { className: cssClasses.radioLabel },
                reactExports.createElement("input", { type: "radio", name: this.question.name, value: value, "aria-errormessage": this.question.ariaErrormessage, checked: value === this.question.booleanValueRendered, disabled: this.question.isDisabledAttr, readOnly: this.question.isReadOnlyAttr, className: cssClasses.itemRadioControl, onChange: this.handleOnChange }),
                this.question.cssClasses.materialRadioDecorator ?
                    (reactExports.createElement("span", { className: cssClasses.materialRadioDecorator }, this.question.itemSvgIcon ?
                        (reactExports.createElement("svg", { className: cssClasses.itemRadioDecorator },
                            reactExports.createElement("use", { xlinkHref: this.question.itemSvgIcon }))) : null)) : null,
                reactExports.createElement("span", { className: cssClasses.radioControlLabel }, this.renderLocString(locText)))));
    }
    renderElement() {
        const cssClasses = this.question.cssClasses;
        return (reactExports.createElement("div", { className: cssClasses.rootRadio },
            reactExports.createElement("fieldset", { role: "presentation", className: cssClasses.radioFieldset }, !this.question.swapOrder ?
...
ReactQuestionFactory.Instance.registerQuestion("sv-boolean-radio", (props) => {
    return reactExports.createElement(SurveyQuestionBooleanRadio, props);
});
...
ReactQuestionFactory.Instance.registerQuestion("empty", (props) => {
    return reactExports.createElement(SurveyQuestionEmpty, props);
});

class MatrixRow extends SurveyElementBase {
    constructor(props) {
        super(props);
        this.root = reactExports.createRef();
    ...
    render() {
        ...
        if (!model.visible)
            return null;
        return (reactExports.createElement("tr", { ref: this.root, className: model.className, "data-sv-drop-target-matrix-row": model.dropTargetId, onPointerDown: (event) => this.onPointerDownHandler(event) }, this.props.children));
    }
}
ReactElementFactory.Instance.registerElement("sv-matrix-row", (props) => {
    return reactExports.createElement(MatrixRow, props);
});
...
class SurveyQuestionMatrixDynamicDragDropIcon extends ReactSurveyElement {
    ...
    renderElement() {
        return reactExports.createElement("div", null, this.renderIcon());
    }
    renderIcon() {
        if (this.question.iconDragElement) {
            return (reactExports.createElement("svg", { className: this.question.cssClasses.dragElementDecorator },
                reactExports.createElement("use", { xlinkHref: this.question.iconDragElement })));
        }
        else {
            return (reactExports.createElement("span", { className: this.question.cssClasses.iconDrag }));
        }
    }
}
ReactElementFactory.Instance.registerElement("sv-matrix-drag-drop-icon", (props) => {
    return reactExports.createElement(SurveyQuestionMatrixDynamicDragDropIcon, props);
});
...
class SurveyQuestionMatrixTable extends SurveyElementBase {
    ...
    renderHeader() {
        ...
        for (var i = 0; i < cells.length; i++) {
            ...
            const header = cell.hasTitle ?
                reactExports.createElement("th", { className: cell.className, key: key, style: columnStyle },
                    " ",
                    cellContent,
                    " ")
                : reactExports.createElement("td", { className: cell.className, key: key, style: columnStyle });
            headers.push(header);
        }
        return (reactExports.createElement("thead", null,
            reactExports.createElement("tr", null, headers)));
    }
    renderFooter() {
        const table = this.question.renderedTable;
        if (!table.showFooter)
        ...
        return reactExports.createElement("tfoot", null, row);
    }
    renderRows() {
        const cssClasses = this.question.cssClasses;
        const rows = [];
        ...
        return reactExports.createElement("tbody", null, rows);
    }
    renderRow(keyValue, row, cssClasses, reason) {
        ...
        return (reactExports.createElement(reactExports.Fragment, { key: key }, (reason == "row-footer") ? reactExports.createElement("tr", null, matrixrow) : reactExports.createElement(MatrixRow, { model: row, parentMatrix: this.question }, matrixrow)));
    }
    renderCell(cell, cssClasses, reason) {
        const key = "cell" + cell.id;
        if (cell.hasQuestion) {
            return (reactExports.createElement(SurveyQuestionMatrixDropdownCell, { key: key, cssClasses: cssClasses, cell: cell, creator: this.creator, reason: reason }));
        }
        if (cell.isErrorsCell) {
            if (cell.isErrorsCell) {
                return (reactExports.createElement(SurveyQuestionMatrixDropdownErrorsCell, { cell: cell, key: key, keyValue: key, question: cell.question, creator: this.creator }));
            }
        }
        ...
        return (reactExports.createElement("td", { className: cell.className, key: key, style: cellStyle, colSpan: cell.colSpans, title: cell.getTitle() }, cellContent));
    }
    renderCellContent(cell, reason, cssClasses) {
        ...
        if (cell.hasTitle) {
            ...
            const require = !!cell.column ? reactExports.createElement(SurveyQuestionMatrixHeaderRequired, { column: cell.column, question: this.question }) : null;
            cellContent = (reactExports.createElement(reactExports.Fragment, null,
                str,
                require));
        }
        if (cell.isDragHandlerCell) {
            cellContent = (reactExports.createElement(reactExports.Fragment, null,
                reactExports.createElement(SurveyQuestionMatrixDynamicDragDropIcon, { item: { data: { row: cell.row, question: this.question } } })));
        }
        ...
        if (cell.hasPanel) {
            cellContent = (reactExports.createElement(SurveyPanel, { key: cell.panel.id, element: cell.panel, survey: this.question.survey, cssClasses: cssClasses, isDisplayMode: this.isDisplayMode, creator: this.creator }));
        }
        if (!cellContent)
            return null;
        const readyCell = (reactExports.createElement(reactExports.Fragment, null, cellContent));
    ...
    renderElement() {
        ...
        return (reactExports.createElement("table", { className: this.question.getTableCss() },
            header,
            rows,
            footers));
    }
...
class SurveyQuestionMatrixDropdownBase extends SurveyQuestionElementBase {
    ...
    renderTableDiv() {
        return (reactExports.createElement("div", { className: this.question.cssClasses.tableWrapper, ref: (root) => (this.setControl(root)) },
            reactExports.createElement(SurveyQuestionMatrixTable, { question: this.question, creator: this.creator, wrapCell: (cell, element, reason) => this.wrapCell(cell, element, reason) })));
    }
}
class SurveyQuestionMatrixActionsCell extends ReactSurveyElement {
    ...
    renderElement() {
        return (reactExports.createElement(SurveyActionBar, { model: this.model, handleClick: false }));
    }
}
class SurveyQuestionMatrixDropdownErrorsCell extends SurveyQuestionErrorCell {
    ...
    render() {
        if (!this.cell.isVisible)
            return null;
        return reactExports.createElement("td", { className: this.cell.className, key: this.key, colSpan: this.cell.colSpans, title: this.cell.getTitle() }, super.render());
    }
    getQuestionPropertiesToTrack() {
...
ReactElementFactory.Instance.registerElement("sv-matrixdynamic-actions-cell", (props) => {
    return reactExports.createElement(SurveyQuestionMatrixActionsCell, props);
});
class SurveyQuestionMatrixHeaderRequired extends ReactSurveyElement {
    ...
    renderElement() {
        ...
        return (reactExports.createElement(reactExports.Fragment, null,
            ...
            reactExports.createElement("span", { className: this.question.cssClasses.cellRequiredMark }, this.column.requiredMark)));
    }
}
class SurveyQuestionMatrixDropdownCell extends SurveyQuestionAndErrorsCell {
    ...
    renderCellContent() {
        ...
        const responsiveTitle = this.cell.showResponsiveTitle ? (reactExports.createElement("span", { className: this.cell.responsiveTitleCss },
            this.renderLocString(this.cell.responsiveLocTitle),
            reactExports.createElement(SurveyQuestionMatrixHeaderRequired, { column: this.cell.column, question: this.cell.matrix }))) : null;
        return reactExports.createElement(reactExports.Fragment, null,
            responsiveTitle,
            content);
    }
    ...
    renderOtherComment() {
        ...
        return reactExports.createElement(SurveyQuestionCommentValueItem, { question: question, item: question.otherItem, cssClasses: cssClasses });
    }
    renderCellCheckboxButton() {
        var key = this.cell.question.id + "item" + this.cell.choiceIndex;
        return (reactExports.createElement(SurveyQuestionCheckboxItem, { key: key, question: this.cell.question, cssClasses: this.cell.question.cssClasses, isDisplayMode: this.cell.question.isInputReadOnly, item: this.cell.item, isFirst: this.cell.isFirstChoice, index: this.cell.choiceIndex.toString(), hideCaption: true, ariaLabel: this.getCellAriaLabel() }));
    }
    renderCellRadiogroupButton() {
        var key = this.cell.question.id + "item" + this.cell.choiceIndex;
        return (reactExports.createElement(SurveyQuestionRadioItem, { key: key, question: this.cell.question, cssClasses: this.cell.question.cssClasses, isDisplayMode: this.cell.question.isInputReadOnly, item: this.cell.item, index: this.cell.choiceIndex.toString(), isChecked: this.cell.question.value === this.cell.item.value, isDisabled: this.cell.question.isReadOnly || !this.cell.item.isEnabled, hideCaption: true, ariaLabel: this.getCellAriaLabel() }));
    }
    getCellAriaLabel() {
...
ReactQuestionFactory.Instance.registerQuestion("matrixdropdown", props => {
    return reactExports.createElement(SurveyQuestionMatrixDropdown, props);
});
...
ReactQuestionFactory.Instance.registerQuestion("matrixdynamic", (props) => {
    return reactExports.createElement(SurveyQuestionMatrixDynamic, props);
});
class SurveyQuestionMatrixDynamicAddButton extends ReactSurveyElement {
    ...
    renderElement() {
        ...
        const addButton = (reactExports.createElement("button", { className: this.matrix.getAddRowButtonCss(this.props.isEmptySection), type: "button", disabled: this.matrix.isInputReadOnly, onClick: this.matrix.isDesignMode ? undefined : this.handleOnRowAddClick },
            addRowText,
            reactExports.createElement("span", { className: this.props.cssClasses.iconAdd })));
        return (this.props.isEmptySection ? addButton : reactExports.createElement("div", { className: this.props.cssClasses.footer }, addButton));
    }
}
class SurveyQuestionMatrixDynamicPlaceholder extends ReactSurveyElement {
    ...
    renderElement() {
        ...
        const textDiv = reactExports.createElement("div", { className: cssClasses.noRowsText }, text);
        const btn = showAddButton ? this.renderAddRowButton(cssClasses, matrix) : undefined;
        return (reactExports.createElement("div", { className: cssClasses.noRowsSection },
            textDiv,
            btn));
    }
...
ReactElementFactory.Instance.registerElement("sv-matrixdynamic-add-btn", (props) => { return reactExports.createElement(SurveyQuestionMatrixDynamicAddButton, props); });
ReactElementFactory.Instance.registerElement("sv-placeholder-matrixdynamic", (props) => { return reactExports.createElement(SurveyQuestionMatrixDynamicPlaceholder, props); });
...
class SurveyQuestionPanelDynamic extends SurveyQuestionElementBase {
    ...
    renderElement() {
        ...
        this.question.renderedPanels.forEach((panel, index) => {
            panels.push(reactExports.createElement(SurveyQuestionPanelDynamicItem, { key: panel.id, element: panel, question: this.question, index: index, cssClasses: cssClasses, isDisplayMode: this.isDisplayMode, creator: this.creator }));
        });
        ...
        return (reactExports.createElement("div", { className: cssClasses.root },
            this.question.hasTabbedMenu ? reactExports.createElement("div", { className: this.question.getTabsContainerCss() },
                reactExports.createElement(SurveyActionBar, { model: this.question.tabbedMenu })) : null,
            noEntriesPlaceholder,
            rangeTop,
            reactExports.createElement("div", { className: this.question.cssClasses.panelsContainer }, panels),
            navV2));
    }
    renderRange() {
        return (reactExports.createElement("div", { className: this.question.cssClasses.progress },
            reactExports.createElement("div", { className: this.question.cssClasses.progressBar, style: { width: this.question.progress }, role: "progressbar", "aria-label": this.question.progressBarAriaLabel })));
    }
    renderAddRowButton() {
    ...
    renderNavigatorV2() {
        ...
        return (reactExports.createElement("div", { className: this.question.cssClasses.footer },
            reactExports.createElement("hr", { className: this.question.cssClasses.separator }),
            range,
            this.question.showFooterToolbar ? (reactExports.createElement("div", { className: this.question.cssClasses.footerButtonsContainer },
                reactExports.createElement(SurveyActionBar, { model: this.question.footerToolbar }))) : null));
    }
...
class SurveyQuestionPanelDynamicItem extends SurveyPanel {
    ...
    render() {
        ...
        const separator = this.question.showSeparator(this.index) ?
            (reactExports.createElement("hr", { className: this.question.cssClasses.separator })) : null;
        return (reactExports.createElement(reactExports.Fragment, null,
            reactExports.createElement("div", { className: this.question.getPanelWrapperCss(this.panel) },
                panel,
                removeButton),
            separator));
    }
...
ReactQuestionFactory.Instance.registerQuestion("paneldynamic", props => {
    return reactExports.createElement(SurveyQuestionPanelDynamic, props);
});
class SurveyQuestionPanelDynamicPlaceholder extends ReactSurveyElement {
    ...
    renderElement() {
        const cssClasses = this.props.cssClasses;
        const question = this.props.question;
        return (reactExports.createElement("div", { className: cssClasses.noEntriesPlaceholder },
            reactExports.createElement("span", null, this.renderLocString(question.locNoEntriesText)),
...
ReactElementFactory.Instance.registerElement("sv-placeholder-paneldynamic", (props) => { return reactExports.createElement(SurveyQuestionPanelDynamicPlaceholder, props); });
...
class SurveyProgress extends SurveyNavigationBase {
    ...
    render() {
        ...
        return (reactExports.createElement("div", { className: this.survey.getProgressCssClasses(this.props.container) },
            reactExports.createElement("div", { style: progressStyle, className: this.css.progressBar, role: "progressbar", "aria-valuemin": 0, "aria-valuemax": 100, "aria-label": this.progressBarAriaLabel },
                reactExports.createElement("span", { className: SurveyProgressModel.getProgressTextInBarCss(this.css) }, this.progressText)),
            reactExports.createElement("span", { className: SurveyProgressModel.getProgressTextUnderBarCss(this.css) }, this.progressText)));
    }
}
ReactElementFactory.Instance.registerElement("sv-progress-pages", props => {
    return reactExports.createElement(SurveyProgress, props);
});
...
class SurveyProgressButtons extends SurveyNavigationBase {
    constructor(props) {
        super(props);
        this.listContainerRef = reactExports.createRef();
    }
    get model() {
        return this.props.model;
    }
    ...
    render() {
        return (reactExports.createElement("div", { className: this.model.getRootCss(this.props.container), style: { "maxWidth": this.model.progressWidth }, role: "progressbar", "aria-valuemin": 0, "aria-valuemax": 100, "aria-label": this.model.progressBarAriaLabel },
            this.state.canShowHeader ? reactExports.createElement("div", { className: this.css.progressButtonsHeader },
                reactExports.createElement("div", { className: this.css.progressButtonsPageTitle, title: this.model.headerText }, this.model.headerText)) : null,
            reactExports.createElement("div", { className: this.css.progressButtonsContainer },
                reactExports.createElement("div", { className: this.model.getScrollButtonCss(this.state.hasScroller, true), role: "button", onClick: () => this.clickScrollButton(this.listContainerRef.current, true) }),
                reactExports.createElement("div", { className: this.css.progressButtonsListContainer, ref: this.listContainerRef },
                    reactExports.createElement("ul", { className: this.css.progressButtonsList }, this.getListElements())),
                reactExports.createElement("div", { className: this.model.getScrollButtonCss(this.state.hasScroller, false), role: "button", onClick: () => this.clickScrollButton(this.listContainerRef.current, false) })),
            this.state.canShowFooter ? reactExports.createElement("div", { className: this.css.progressButtonsFooter },
                reactExports.createElement("div", { className: this.css.progressButtonsPageTitle, title: this.model.footerText }, this.model.footerText)) : null));
    }
    getListElements() {
        let buttons = [];
    ...
    renderListElement(page, index) {
        ...
        return (reactExports.createElement("li", { key: "listelement" + index, className: this.model.getListElementCss(index), onClick: this.model.isListElementClickable(index)
                ? () => this.model.clickListElement(page)
                : undefined, "data-page-number": this.model.getItemNumber(page) },
            reactExports.createElement("div", { className: this.css.progressButtonsConnector }),
            this.state.canShowItemTitles ? reactExports.createElement(reactExports.Fragment, null,
                reactExports.createElement("div", { className: this.css.progressButtonsPageTitle, title: page.renderedNavigationTitle }, text),
                reactExports.createElement("div", { className: this.css.progressButtonsPageDescription, title: page.navigationDescription }, page.navigationDescription)) : null,
            reactExports.createElement("div", { className: this.css.progressButtonsButton },
                reactExports.createElement("div", { className: this.css.progressButtonsButtonBackground }),
                reactExports.createElement("div", { className: this.css.progressButtonsButtonContent }),
                reactExports.createElement("span", null, this.model.getItemNumber(page)))));
    }
...
ReactElementFactory.Instance.registerElement("sv-progress-buttons", (props) => {
    return reactExports.createElement(SurveyProgressButtons, props);
});
...
class ListItem extends SurveyElementBase {
    ...
    render() {
        ...
        const contentWrap = reactExports.createElement("div", { style: this.model.getItemStyle(this.item), className: this.model.cssClasses.itemBody, title: this.item.getTooltip(), onMouseOver: (event) => { this.model.onItemHover(this.item); }, onMouseLeave: (event) => { this.model.onItemLeave(this.item); } }, newElement);
        const separator = this.item.needSeparator ? reactExports.createElement("div", { className: this.model.cssClasses.itemSeparator }) : null;
        const isVisible = this.model.isItemVisible(this.item);
        const style = {
            display: isVisible ? null : "none"
        };
        return attachKey2click(reactExports.createElement("li", { className: className, role: this.model.listItemRole, style: style, id: this.item.elementId, "aria-selected": this.model.getA11yItemAriaSelected(this.item), "aria-checked": this.model.getA11yItemAriaChecked(this.item), onClick: (event) => {
...
ReactElementFactory.Instance.registerElement("sv-list-item", (props) => {
    return reactExports.createElement(ListItem, props);
});
...
class List extends SurveyElementBase {
    ...
    renderElement() {
        return (reactExports.createElement("div", { className: this.model.cssClasses.root, ref: this.listContainerRef },
    ...
    renderList() {
        ...
        return (reactExports.createElement("ul", { className: this.model.getListClass(), style: ulStyle, role: this.model.listRole, "aria-label": this.model.a11ya11y_input_ariaLabel, id: this.model.elementId, onMouseDown: (e) => {
                e.preventDefault();
    ...
    renderItems() {
        ...
        return items.map((item, itemIndex) => {
            return (reactExports.createElement(ListItem, { model: this.model, item: item, key: "item" + itemIndex }));
        });
    }
    searchElementContent() {
        if (!this.model.showFilter)
            ...
            const clearButton = this.model.showSearchClearButton && !!this.model.filterString ?
                reactExports.createElement("button", { className: this.model.cssClasses.searchClearButtonIcon, onClick: (event) => { this.model.onClickSearchClearButton(event); } },
                    reactExports.createElement(SvgIcon, { iconName: "icon-searchclear", size: "auto" })) : null;
            return (reactExports.createElement("div", { className: this.model.cssClasses.filter },
                reactExports.createElement("div", { className: this.model.cssClasses.filterIcon },
                    reactExports.createElement(SvgIcon, { iconName: "icon-search", size: "auto" })),
                reactExports.createElement("input", { type: "text", className: this.model.cssClasses.filterInput, "aria-label": this.model.filterStringPlaceholder, placeholder: this.model.filterStringPlaceholder, value: this.state.filterString, onKeyUp: onKeyUp, onChange: onChange }),
                clearButton));
        }
    }
    emptyContent() {
        const style = { display: this.model.isEmpty ? null : "none" };
        return (reactExports.createElement("div", { className: this.model.cssClasses.emptyContainer, style: style },
            reactExports.createElement("div", { className: this.model.cssClasses.emptyText, "aria-label": this.model.emptyMessage }, this.model.emptyMessage)));
    }
}
ReactElementFactory.Instance.registerElement("sv-list", (props) => {
    return reactExports.createElement(List, props);
});
...
class SurveyProgressToc extends SurveyNavigationBase {
    ...
    render() {
        ...
        if (tocModel.isMobile) {
            content = reactExports.createElement("div", { onClick: tocModel.togglePopup },
                reactExports.createElement(SvgIcon, { iconName: tocModel.icon, size: 24 }),
                reactExports.createElement(Popup, { model: tocModel.popupModel }));
        }
        else {
            content = reactExports.createElement(List, { model: tocModel.listModel });
        }
        return (reactExports.createElement("div", { className: tocModel.containerCss }, content));
    }
}
ReactElementFactory.Instance.registerElement("sv-navigation-toc", (props) => {
    return reactExports.createElement(SurveyProgressToc, props);
});
...
class SurveyQuestionRating extends SurveyQuestionElementBase {
    ...
    renderElement() {
        ...
        var maxText = this.question.maxRateDescription
            ...
            : null;
        return (reactExports.createElement("div", { className: this.question.ratingRootCss, ref: (div) => (this.setControl(div)) },
            reactExports.createElement("fieldset", { role: this.question.a11y_input_ariaRole, "aria-required": this.question.a11y_input_ariaRequired, "aria-label": this.question.a11y_input_ariaLabel, "aria-labelledby": this.question.a11y_input_ariaLabelledBy, "aria-describedby": this.question.a11y_input_ariaDescribedBy, "aria-invalid": this.question.a11y_input_ariaInvalid, "aria-errormessage": this.question.a11y_input_ariaErrormessage },
                reactExports.createElement("legend", { role: "presentation", className: "sv-hidden" }),
                !!this.question.hasMinLabel ? reactExports.createElement("span", { className: cssClasses.minText }, minText) : null,
                this.question.renderedRateItems.map((item, index) => this.renderItem(item, index)),
                !!this.question.hasMaxLabel ? reactExports.createElement("span", { className: cssClasses.maxText }, maxText) : null)));
    }
}
ReactQuestionFactory.Instance.registerQuestion("rating", (props) => {
    return reactExports.createElement(SurveyQuestionRating, props);
});
...
class SurveyQuestionRatingDropdown extends SurveyQuestionDropdownBase {
    ...
    renderElement() {
        ...
        return (reactExports.createElement("div", { className: this.question.cssClasses.rootDropdown }, select));
    }
}
ReactQuestionFactory.Instance.registerQuestion("sv-rating-dropdown", (props) => {
    return reactExports.createElement(SurveyQuestionRatingDropdown, props);
});
...
class SurveyQuestionSlider extends SurveyQuestionElementBase {
    constructor(props) {
        super(props);
        this.rangeInputRef = reactExports.createRef();
    }
    componentDidMount() {
        super.componentDidMount();
    ...
    renderElement() {
        ...
        return (reactExports.createElement("div", { className: this.question.rootCss, ref: (div) => (this.setControl(div)) },
            rangeInput,
            reactExports.createElement("div", { className: cssClasses.visualContainer, onPointerUp: (e) => { setValueByClickOnPath(e.nativeEvent, this.control); } },
                reactExports.createElement("div", { className: cssClasses.visualContainerSlider },
                    reactExports.createElement("div", { className: cssClasses.inverseTrackLeft, style: { width: getTrackPercentLeft() + "%" } }),
                    reactExports.createElement("div", { className: cssClasses.inverseTrackRight, style: { width: getTrackPercentRight() + "%" } }),
                    reactExports.createElement("div", { className: cssClasses.rangeTrack, style: { left: getTrackPercentLeft() + "%", right: getTrackPercentRight() + "%" } }),
                    thumbsAndInputs)),
            labels));
    }
    getInputsAndThumbs() {
        ...
        for (let i = 0; i < value.length; i++) {
            const thumbAndInput = reactExports.createElement(reactExports.Fragment, { key: i },
                this.getInput(i),
                this.getThumb(i));
    ...
    getThumb(i) {
        ...
        if (tooltipVisibility !== "never") {
            tooltip = reactExports.createElement("div", { className: tooltipCss },
                reactExports.createElement("div", { className: cssClasses.tooltipPanel },
                    reactExports.createElement("div", { className: cssClasses.tooltipValue }, getTooltipValue(i))));
        }
        const thumb = reactExports.createElement("div", { className: getThumbContainerCss(i), style: { left: getPercent(value) + "%" } },
            tooltip,
            reactExports.createElement("div", { className: cssClasses.thumb },
                reactExports.createElement("div", { className: cssClasses.thumbDot })));
        return thumb;
    }
    getInput(i) {
    ...
    getLabels() {
        ...
        return reactExports.createElement("div", { className: cssClasses.labelsContainer },
            reactExports.createElement("div", null, labels));
    }
}
ReactQuestionFactory.Instance.registerQuestion("slider", (props) => {
    return reactExports.createElement(SurveyQuestionSlider, props);
});
...
class SurveyQuestionExpression extends SurveyQuestionElementBase {
    ...
    renderElement() {
        var cssClasses = this.question.cssClasses;
        return (reactExports.createElement("div", { id: this.question.inputId, className: cssClasses.root, ref: (div) => (this.setControl(div)), "aria-live": "polite", "aria-label": this.question.formatedValue }, this.question.formatedValue));
    }
}
ReactQuestionFactory.Instance.registerQuestion("expression", (props) => {
    return reactExports.createElement(SurveyQuestionExpression, props);
});
...
class PopupSurvey extends Survey {
    ...
    renderElement() {
        ...
        return (reactExports.createElement("div", { className: this.popup.cssRoot, style: style, onScroll: () => this.popup.onScroll() },
            reactExports.createElement("div", { className: this.popup.cssRootContent },
                header,
                body)));
    }
    renderWindowHeader() {
        ...
        return (reactExports.createElement("div", { className: popup.cssHeaderRoot },
            titleCollapsed,
            reactExports.createElement("div", { className: popup.cssHeaderButtonsContainer },
                allowFullScreenButon,
                reactExports.createElement("div", { className: popup.cssHeaderCollapseButton, onClick: this.handleOnExpanded }, expandCollapseIcon),
                closeButton)));
    }
    renderTitleCollapsed(popup) {
        if (!popup.locTitle)
            return null;
        return reactExports.createElement("div", { className: popup.cssHeaderTitleCollapsed }, popup.locTitle.renderedHtml);
    }
    renderExpandIcon() {
        return reactExports.createElement(SvgIcon, { iconName: "icon-restore_16x16", size: 16 });
    }
    renderCollapseIcon() {
        return reactExports.createElement(SvgIcon, { iconName: "icon-minimize_16x16", size: 16 });
    }
    renderCloseButton(popup) {
        return (reactExports.createElement("div", { className: popup.cssHeaderCloseButton, onClick: () => {
                popup.hide();
                if (typeof this.props.onClose == "function") {
                    this.props.onClose();
                }
            } },
            reactExports.createElement(SvgIcon, { iconName: "icon-close_16x16", size: 16 })));
    }
    renderAllowFullScreenButon(popup) {
        let Icon;
        if (popup.isFullScreen) {
            Icon = reactExports.createElement(SvgIcon, { iconName: "icon-back-to-panel_16x16", size: 16 });
        }
        else {
            Icon = reactExports.createElement(SvgIcon, { iconName: "icon-full-screen_16x16", size: 16 });
        }
        return (reactExports.createElement("div", { className: popup.cssHeaderFullScreenButton, onClick: () => { popup.toggleFullScreen(); } }, Icon));
    }
    renderBody() {
        return reactExports.createElement("div", { className: this.popup.cssBody }, this.doRender());
    }
    createSurvey(newProps) {
        if (!newProps)
            newProps = {};
...
class SurveyQuestionImagePicker extends SurveyQuestionElementBase {
    ...
    renderElement() {
        var cssClasses = this.question.cssClasses;
        return (reactExports.createElement("fieldset", { className: this.question.getSelectBaseRootCss(), style: this.question.getContainerStyle() },
            reactExports.createElement("legend", { className: "sv-hidden" }, this.question.locTitle.renderedHtml),
    ...
    renderItem(key, item, cssClasses) {
        const renderedItem = reactExports.createElement(SurveyQuestionImagePickerItem, { key: key, question: this.question, item: item, cssClasses: cssClasses });
        const survey = this.question.survey;
        let wrappedItem = null;
        if (!!survey) {
            wrappedItem = ReactSurveyElementsWrapper.wrapItemValue(survey, renderedItem, this.question, item);
...
class SurveyQuestionImagePickerItem extends ReactSurveyElement {
    ...
    renderElement() {
        ...
        if (question.showLabel) {
            text = (reactExports.createElement("span", { className: question.cssClasses.itemText }, item.text ? SurveyElementBase.renderLocString(item.locText) : item.value));
        }
        var style = { objectFit: this.question.imageFit };
        var control = null;
        if (item.locImageLink.renderedHtml && this.question.contentMode === "image") {
            control = (reactExports.createElement("img", { className: cssClasses.image, src: item.locImageLink.renderedHtml, width: this.question.renderedImageWidth, height: this.question.renderedImageHeight, alt: item.locText.renderedHtml, style: style, onLoad: (event) => { this.question["onContentLoaded"](item, event.nativeEvent); }, onError: (event) => { item.onErrorHandler(item, event.nativeEvent); } }));
        }
        if (item.locImageLink.renderedHtml && this.question.contentMode === "video") {
            control = (reactExports.createElement("video", { controls: true, className: cssClasses.image, src: item.locImageLink.renderedHtml, width: this.question.renderedImageWidth, height: this.question.renderedImageHeight, style: style, onLoadedMetadata: (event) => { this.question["onContentLoaded"](item, event.nativeEvent); }, onError: (event) => { item.onErrorHandler(item, event.nativeEvent); } }));
        }
        if (!item.locImageLink.renderedHtml || item.contentNotLoaded) {
            ...
            control = (reactExports.createElement("div", { className: cssClasses.itemNoImage, style: style }, cssClasses.itemNoImageSvgIcon ?
                reactExports.createElement(SvgIcon, { className: cssClasses.itemNoImageSvgIcon, iconName: this.question.cssClasses.itemNoImageSvgIconId, size: 48 }) :
                null));
        }
        const renderedItem = (reactExports.createElement("div", { className: itemClass },
            reactExports.createElement("label", { className: cssClasses.label },
                reactExports.createElement("input", { className: cssClasses.itemControl, id: this.question.getItemId(item), type: this.question.inputType, name: this.question.questionName, checked: isChecked, value: item.value, disabled: !this.question.getItemEnabled(item), readOnly: this.question.isReadOnlyAttr, onChange: this.handleOnChange, required: this.question.inputRequiredAttribute, "aria-label": item.locText.renderedHtml, "aria-invalid": this.question.ariaInvalid, "aria-errormessage": this.question.ariaErrormessage }),
                reactExports.createElement("div", { className: this.question.cssClasses.itemDecorator },
                    reactExports.createElement("div", { className: this.question.cssClasses.imageContainer },
                        !!this.question.cssClasses.checkedItemDecorator ?
                            reactExports.createElement("span", { className: this.question.cssClasses.checkedItemDecorator, "aria-hidden": "true" }, !!this.question.cssClasses.checkedItemSvgIconId ? reactExports.createElement(SvgIcon, { size: "auto", className: this.question.cssClasses.checkedItemSvgIcon, iconName: this.question.cssClasses.checkedItemSvgIconId }) : null) : null,
                        control),
                    text))));
        return renderedItem;
    }
...
ReactQuestionFactory.Instance.registerQuestion("imagepicker", (props) => {
    return reactExports.createElement(SurveyQuestionImagePicker, props);
});
...
class SurveyQuestionImage extends SurveyQuestionElementBase {
    ...
    renderElement() {
        ...
        if (this.question.renderedMode === "image") {
            control = (reactExports.createElement("img", { className: cssClasses, src: this.question.locImageLink.renderedHtml || null, alt: this.question.renderedAltText, width: this.question.renderedWidth, height: this.question.renderedHeight, style: style, onLoad: (event) => { this.question.onLoadHandler(); }, onError: (event) => { this.question.onErrorHandler(); } }));
        }
        if (this.question.renderedMode === "video") {
            control = (reactExports.createElement("video", { controls: true, className: cssClasses, src: this.question.locImageLink.renderedHtml, width: this.question.renderedWidth, height: this.question.renderedHeight, style: style, onLoadedMetadata: (event) => { this.question.onLoadHandler(); }, onError: (event) => { this.question.onErrorHandler(); } }));
        }
        if (this.question.renderedMode === "youtube") {
            control = (reactExports.createElement("iframe", { className: cssClasses, src: this.question.locImageLink.renderedHtml, width: this.question.renderedWidth, height: this.question.renderedHeight, style: style, title: this.question.renderedAltText }));
        }
        var noImage = null;
        if (!this.question.imageLink || this.question.contentNotLoaded) {
            noImage = (reactExports.createElement("div", { className: this.question.cssClasses.noImage },
                reactExports.createElement(SvgIcon, { iconName: this.question.cssClasses.noImageSvgIconId, size: 48 })));
        }
        return reactExports.createElement("div", { className: this.question.cssClasses.root },
            control,
            noImage);
    }
}
ReactQuestionFactory.Instance.registerQuestion("image", (props) => {
    return reactExports.createElement(SurveyQuestionImage, props);
});
...
class SurveyQuestionSignaturePad extends SurveyQuestionElementBase {
    ...
    renderElement() {
        ...
        return (reactExports.createElement("div", { className: cssClasses.root, ref: (root) => (this.setControl(root)), style: { width: this.question.renderedCanvasWidth } },
            reactExports.createElement("div", { className: cssClasses.placeholder, style: { display: this.question.needShowPlaceholder() ? "" : "none" } }, this.renderLocString(this.question.locRenderedPlaceholder)),
            reactExports.createElement("div", null,
                this.renderBackgroundImage(),
                reactExports.createElement("canvas", { tabIndex: -1, className: this.question.cssClasses.canvas, onBlur: (event) => { this.question.onBlur(event); } })),
            clearButton,
            loadingIndicator));
    }
    renderBackgroundImage() {
        if (!this.question.backgroundImage)
            return null;
        return reactExports.createElement("img", { className: this.question.cssClasses.backgroundImage, src: this.question.backgroundImage, style: { width: this.question.renderedCanvasWidth }, role: "presentation" });
    }
    renderLoadingIndicator() {
        return reactExports.createElement("div", { className: this.question.cssClasses.loadingIndicator },
            reactExports.createElement(LoadingIndicatorComponent, null));
    ...
    renderCleanButton() {
        if (!this.question.canShowClearButton)
            return null;
        var cssClasses = this.question.cssClasses;
        return reactExports.createElement("div", { className: cssClasses.controls },
            reactExports.createElement("button", { type: "button", className: cssClasses.clearButton, title: this.question.clearButtonCaption, onClick: () => this.question.clearValue(true) }, this.question.cssClasses.clearButtonIconId ? reactExports.createElement(SvgIcon, { iconName: this.question.cssClasses.clearButtonIconId, size: "auto" }) : reactExports.createElement("span", null, "\u2716")));
    }
}
ReactQuestionFactory.Instance.registerQuestion("signaturepad", (props) => {
    return reactExports.createElement(SurveyQuestionSignaturePad, props);
});
...
class SurveyQuestionButtonGroup extends SurveyQuestionElementBase {
    ...
    renderElement() {
        const items = this.renderItems();
        return reactExports.createElement("div", { className: this.question.cssClasses.root }, items);
    }
    renderItems() {
        return this.question.visibleChoices.map((item, index) => {
            return (reactExports.createElement(SurveyButtonGroupItem, { key: this.question.inputId + "_" + index, item: item, question: this.question, index: index }));
        });
    }
}
ReactQuestionFactory.Instance.registerQuestion("buttongroup", (props) => {
    return reactExports.createElement(SurveyQuestionButtonGroup, props);
});
class SurveyButtonGroupItem extends SurveyElementBase {
    ...
    renderElement() {
        ...
        return (reactExports.createElement("label", { className: this.model.css.label, title: this.model.caption.renderedHtml },
            input,
            reactExports.createElement("div", { className: this.model.css.decorator },
                icon,
                caption)));
    }
    renderIcon() {
        if (!!this.model.iconName) {
            return (reactExports.createElement(SvgIcon, { className: this.model.css.icon, iconName: this.model.iconName, size: this.model.iconSize || 24 }));
        }
        return null;
    }
    renderInput() {
        return (reactExports.createElement("input", { className: this.model.css.control, id: this.model.id, type: "radio", name: this.model.name, checked: this.model.selected, value: this.model.value, disabled: this.model.readOnly, onChange: () => {
                this.model.onChange();
    ...
    renderCaption() {
        ...
        return (reactExports.createElement("span", { className: this.model.css.caption, title: this.model.caption.renderedHtml }, caption));
    }
}
// ReactQuestionFactory.Instance.registerQuestion("buttongroup", props => {
...
ReactQuestionFactory.Instance.registerQuestion("sv-buttongroup-dropdown", (props) => {
    return reactExports.createElement(SurveyQuestionButtonGroupDropdown, props);
});
...
class SurveyQuestionComposite extends SurveyQuestionUncontrolledElement {
    ...
    renderElement() {
        return (reactExports.createElement(SurveyPanel, { element: this.question.contentPanel, creator: this.creator, survey: this.question.survey }));
    }
}
ReactQuestionFactory.Instance.registerQuestion("custom", (props) => {
    return reactExports.createElement(SurveyQuestionCustom, props);
});
ReactQuestionFactory.Instance.registerQuestion("composite", (props) => {
    return reactExports.createElement(SurveyQuestionComposite, props);
});
...
class ListItemContent extends SurveyElementBase {
    ...
    render() {
        ...
        const icon = (this.item.iconName) ?
            reactExports.createElement(SvgIcon, { className: this.model.cssClasses.itemIcon, iconName: this.item.iconName, size: this.item.iconSize, "aria-label": this.item.title }) : null;
        const markerIcon = (this.item.markerIconName) ?
            reactExports.createElement(SvgIcon, { className: this.item.cssClasses.itemMarkerIcon, iconName: this.item.markerIconName, size: "auto" }) : null;
        return reactExports.createElement(reactExports.Fragment, null,
            icon,
            text,
            markerIcon);
...
ReactElementFactory.Instance.registerElement("sv-list-item-content", (props) => {
    return reactExports.createElement(ListItemContent, props);
});
...
class ListItemGroup extends SurveyElementBase {
    ...
    render() {
        ...
        return reactExports.createElement(reactExports.Fragment, null,
            newElement,
            reactExports.createElement(Popup, { model: (_a = this.item) === null || _a === void 0 ? void 0 : _a.popupModel }));
    }
}
ReactElementFactory.Instance.registerElement("sv-list-item-group", (props) => {
    return reactExports.createElement(ListItemGroup, props);
});

class LogoImage extends reactExports.Component {
    constructor(props) {
        super(props);
    }
    get survey() {
    ...
    render() {
        const content = [];
        content.push(reactExports.createElement("div", { key: "logo-image", className: this.survey.logoClassNames },
            reactExports.createElement("img", { className: this.survey.css.logoImage, src: this.survey.locLogo.renderedHtml || null, alt: this.survey.locTitle.renderedHtml, width: this.survey.renderedLogoWidth, height: this.survey.renderedLogoHeight, style: { objectFit: this.survey.logoFit, width: this.survey.renderedStyleLogoWidth, height: this.survey.renderedStyleLogoHeight } })));
        return reactExports.createElement(reactExports.Fragment, null, content);
    }
}
ReactElementFactory.Instance.registerElement("sv-logo-image", (props) => {
    return reactExports.createElement(LogoImage, props);
});
...
class SurveyQuestionMatrixDynamicRemoveButton extends ReactSurveyElement {
    ...
    renderElement() {
        ...
        return (reactExports.createElement("button", { className: this.question.getRemoveRowButtonCss(), type: "button", onClick: this.handleOnRowRemoveClick, disabled: this.question.isInputReadOnly },
            removeRowText,
            reactExports.createElement("span", { className: this.question.cssClasses.iconRemove })));
    }
}
ReactElementFactory.Instance.registerElement("sv-matrix-remove-button", (props) => {
    return reactExports.createElement(SurveyQuestionMatrixDynamicRemoveButton, props);
});
...
class SurveyQuestionMatrixDetailButton extends ReactSurveyElement {
    ...
    renderElement() {
        ...
        return (reactExports.createElement("button", { type: "button", title: this.props.item.title, onClick: this.handleOnShowHideClick, className: this.question.getDetailPanelButtonCss(this.row), "aria-expanded": ariaExpanded, "aria-controls": ariaControls },
            reactExports.createElement(SvgIcon, { className: this.question.getDetailPanelIconCss(this.row), iconName: this.question.getDetailPanelIconId(this.row), size: "auto" })));
    }
}
ReactElementFactory.Instance.registerElement("sv-matrix-detail-button", props => {
    return reactExports.createElement(SurveyQuestionMatrixDetailButton, props);
});
...
class SurveyQuestionPanelDynamicAddButton extends SurveyQuestionPanelDynamicAction {
    ...
    renderElement() {
        ...
        return (reactExports.createElement("button", { type: "button", id: this.question.addButtonId, className: this.question.getAddButtonCss(), onClick: this.handleClick },
            reactExports.createElement("span", { className: this.question.cssClasses.buttonAddText }, btnText)));
    }
}
ReactElementFactory.Instance.registerElement("sv-paneldynamic-add-btn", (props) => {
    return reactExports.createElement(SurveyQuestionPanelDynamicAddButton, props);
});
...
class SurveyQuestionPanelDynamicRemoveButton extends SurveyQuestionPanelDynamicAction {
    ...
    renderElement() {
        ...
        return (reactExports.createElement("button", { id: id, className: this.question.getPanelRemoveButtonCss(), onClick: this.handleClick, type: "button" },
            reactExports.createElement("span", { className: this.question.cssClasses.buttonRemoveText }, btnText),
            reactExports.createElement("span", { className: this.question.cssClasses.iconRemove })));
    }
}
ReactElementFactory.Instance.registerElement("sv-paneldynamic-remove-btn", (props) => {
    return reactExports.createElement(SurveyQuestionPanelDynamicRemoveButton, props);
});
...
class SurveyQuestionPanelDynamicPrevButton extends SurveyQuestionPanelDynamicAction {
    ...
    renderElement() {
        return (reactExports.createElement("div", { title: this.question.panelPrevText, onClick: this.handleClick, className: this.question.getPrevButtonCss() },
            reactExports.createElement(SvgIcon, { iconName: this.question.cssClasses.progressBtnIcon, size: "auto" })));
    }
}
ReactElementFactory.Instance.registerElement("sv-paneldynamic-prev-btn", (props) => {
    return reactExports.createElement(SurveyQuestionPanelDynamicPrevButton, props);
});
...
class SurveyQuestionPanelDynamicNextButton extends SurveyQuestionPanelDynamicAction {
    ...
    renderElement() {
        return (reactExports.createElement("div", { title: this.question.panelNextText, onClick: this.handleClick, className: this.question.getNextButtonCss() },
            reactExports.createElement(SvgIcon, { iconName: this.question.cssClasses.progressBtnIcon, size: "auto" })));
    }
}
ReactElementFactory.Instance.registerElement("sv-paneldynamic-next-btn", (props) => {
    return reactExports.createElement(SurveyQuestionPanelDynamicNextButton, props);
});

class SurveyQuestionPanelDynamicProgressText extends SurveyQuestionPanelDynamicAction {
    renderElement() {
        return (reactExports.createElement("div", { className: this.question.cssClasses.progressText }, this.question.progressText));
    }
}
ReactElementFactory.Instance.registerElement("sv-paneldynamic-progress-text", (props) => {
    return reactExports.createElement(SurveyQuestionPanelDynamicProgressText, props);
});
...
class SurveyNavigationButton extends ReactSurveyElement {
    ...
    renderElement() {
        return (reactExports.createElement("input", { className: this.item.innerCss, type: "button", disabled: this.item.disabled, onMouseDown: this.item.data && this.item.data.mouseDown, onClick: this.item.action, title: this.item.getTooltip(), value: this.item.title }));
    }
}
ReactElementFactory.Instance.registerElement("sv-nav-btn", (props) => {
    return reactExports.createElement(SurveyNavigationButton, props);
});

class SurveyLocStringViewer extends reactExports.Component {
    constructor(props) {
        super(props);
    ...
    renderString() {
        ...
        if (this.locStr.hasHtml) {
            ...
            return reactExports.createElement("span", { ref: this.rootRef, className: className, style: this.style, dangerouslySetInnerHTML: htmlValue });
        }
        return reactExports.createElement("span", { ref: this.rootRef, className: className, style: this.style }, this.locStr.renderedHtml);
    }
}
ReactElementFactory.Instance.registerElement(LocalizableString.defaultRenderer, (props) => {
    return reactExports.createElement(SurveyLocStringViewer, props);
});

class QuestionErrorComponent extends reactExports.Component {
    render() {
        return (reactExports.createElement("div", null,
            reactExports.createElement("span", { className: this.props.cssClasses.error.icon || undefined, "aria-hidden": "true" }),
            reactExports.createElement("span", { className: this.props.cssClasses.error.item || undefined },
                reactExports.createElement(SurveyLocStringViewer, { locStr: this.props.error.locText }))));
    }
}
ReactElementFactory.Instance.registerElement("sv-question-error", (props) => {
    return reactExports.createElement(QuestionErrorComponent, props);
});
...
class SliderLabelItem extends SurveyElementBase {
    ...
    renderElement() {
        ...
        return reactExports.createElement("div", { key: this.item.id, className: getLabelCss(locText), style: { left: getPercent(value) + "%" }, onPointerUp: (e) => { handleLabelPointerUp(e.nativeEvent, value); } },
            reactExports.createElement("div", { className: cssClasses.labelTick }),
            reactExports.createElement("div", { className: cssClasses.labelText }, this.renderLocString(locText)));
    }
}
ReactElementFactory.Instance.registerElement("sv-slider-label-item", (props) => {
    return reactExports.createElement(SliderLabelItem, props);
});

class Skeleton extends reactExports.Component {
    render() {
        var _a, _b;
        return (reactExports.createElement("div", { className: "sv-skeleton-element", id: (_a = this.props.element) === null || _a === void 0 ? void 0 : _a.id, style: { height: (_b = this.props.element) === null || _b === void 0 ? void 0 : _b.skeletonHeight } }));
    }
}
ReactElementFactory.Instance.registerElement("sv-skeleton", (props) => {
    return reactExports.createElement(Skeleton, props);
});

class HeaderMobile extends reactExports.Component {
    get model() {
        return this.props.model;
    }
    renderLogoImage() {
    ...
    render() {
        return (reactExports.createElement("div", { className: "sv-header--mobile" },
            this.model.survey.hasLogo ? (reactExports.createElement("div", { className: "sv-header__logo" }, this.renderLogoImage())) : null,
            this.model.survey.hasTitle ? (reactExports.createElement("div", { className: "sv-header__title", style: { maxWidth: this.model.renderedTextAreaWidth } },
                reactExports.createElement(TitleElement, { element: this.model.survey }))) : null,
            this.model.survey.renderedHasDescription ? (reactExports.createElement("div", { className: "sv-header__description", style: { maxWidth: this.model.renderedTextAreaWidth } },
                reactExports.createElement("div", { className: this.model.survey.css.description }, SurveyElementBase.renderLocString(this.model.survey.locDescription)))) : null));
    }
}
class HeaderCell extends reactExports.Component {
    get model() {
        return this.props.model;
    }
    renderLogoImage() {
    ...
    render() {
        return (reactExports.createElement("div", { className: this.model.css, style: this.model.style },
            reactExports.createElement("div", { className: "sv-header__cell-content", style: this.model.contentStyle },
                this.model.showLogo ? (reactExports.createElement("div", { className: "sv-header__logo" }, this.renderLogoImage())) : null,
                this.model.showTitle ? (reactExports.createElement("div", { className: "sv-header__title", style: { maxWidth: this.model.textAreaWidth } },
                    reactExports.createElement(TitleElement, { element: this.model.survey }))) : null,
                this.model.showDescription ? (reactExports.createElement("div", { className: "sv-header__description", style: { maxWidth: this.model.textAreaWidth } },
                    reactExports.createElement("div", { className: this.model.survey.css.description }, SurveyElementBase.renderLocString(this.model.survey.locDescription)))) : null)));
    }
}
class Header extends SurveyElementBase {
    ...
    renderElement() {
        ...
        if (this.props.survey.isMobile) {
            headerContent = reactExports.createElement(HeaderMobile, { model: this.model });
        }
        else {
            headerContent = (reactExports.createElement("div", { className: this.model.contentClasses, style: { maxWidth: this.model.maxWidth } }, this.model.cells.map((cell, index) => reactExports.createElement(HeaderCell, { key: index, model: cell }))));
        }
        return (reactExports.createElement("div", { className: this.model.headerClasses, style: { height: this.model.renderedHeight } },
            this.model.backgroundImage ? reactExports.createElement("div", { style: this.model.backgroundImageStyle, className: this.model.backgroundImageClasses }) : null,
            headerContent));
    }
    componentDidMount() {
        super.componentDidMount();
...
ReactElementFactory.Instance.registerElement("sv-header", (props) => {
    return reactExports.createElement(Header, props);
});

class SurveyLocStringEditor extends reactExports.Component {
    constructor(props) {
        super(props);
        this.onInput = (event) => {
    ...
    render() {
        ...
        if (this.locStr.hasHtml) {
            ...
            return (reactExports.createElement("span", { className: "sv-string-editor", contentEditable: "true", suppressContentEditableWarning: true, style: this.style, dangerouslySetInnerHTML: htmlValue, onBlur: this.onInput, onClick: this.onClick }));
        }
        return (reactExports.createElement("span", { className: "sv-string-editor", contentEditable: "true", suppressContentEditableWarning: true, style: this.style, onBlur: this.onInput, onClick: this.onClick }, this.locStr.renderedHtml));
    }
}
